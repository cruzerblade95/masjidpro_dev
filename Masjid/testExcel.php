...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <h4>Excel Upload Tanggungan</h4>
      <hr>
      <form method="post" action="uploadExcelTanggungan.php" enctype="multipart/form-data">
        <div class="form-group row">
          <label class="col-md-3">Select File</label>
          <div class="col-md-8">
        <input type="file" name="uploadTanggungan" class="form-control"/>
        </div>
        </div>
