...
<div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <div class="table-responsive">
                               <form method="post" id="ibu_tunggal" action="setiausaha/update_sakitkronik.php">          
              ...
              <div align="center"><a href="utama.php?view=setiausaha&action=butiran_khairat&id_data=<?php echo $row['id_data'];?>"><input type="button" value="Daftar" class="btn btn-success" /></a></div> 
