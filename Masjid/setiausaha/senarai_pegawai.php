    ...
    <div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">SENARAI PEGAWAI MASJID</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Senarai Pegawai Masjid | <button class="btn btn-success" type="button" onclick="history.go(-1)">Kembali</button></div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                      ...
                                      <tr class="odd gradeX">
                                            ...
                                            <td><div align="center"><a href="utama.php?view=setiausaha&action=semak_pegawai&id_data=<?php echo $row['id_data'];?>">[Semak]</a></div></td>
