   <div class="row">
                <div class="col-lg-12">
                    <h2 align="center" class="page-header">KEMASKINI AHLI KARIAH</h2>
                </div>
                <!-- /.col-lg-12 -->
</div>
 <?php 
   ...
   <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Maklumat Ahli Kariah</div>

                        <div class="panel-body">
							     
                    <form method="post" id="layak_mengundi" action="admin/update_ahlikariah.php">
...
<option value="<?php echo $id;?>"<?php echo $sel_select; ?>> <?php echo $caption ?></option>
	...
	<button class="btn btn-success" type="button" onclick="history.go(-1)">Kembali</button>        
							                                        </div>  
							                                <!-- /.col-lg-4 (nested) -->
							                            </div>
