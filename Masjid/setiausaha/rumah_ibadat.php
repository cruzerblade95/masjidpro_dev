    ...
    <div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">RUMAH IBADAT</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <button class="btn btn-info" type="button" data-toggle="modal" data-target="#myModal">Tambah Rumah Ibadat </button>&nbsp;&nbsp;<button class="btn btn-info" onclick="history.go(-1);">Kembali </button>                   </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
						  ...
						  $sql_search="SELECT id,nama_pengurus,no_tel,bil_anggota,nama_rumahibadat FROM sej6x_data_rumahibadat"; 
						  ...
						  ?>              
                              ...
                              <?php while($row = mysql_fetch_assoc($result)){ ?>
                                    ...
                                    <td class="center"><div align="center"><?php echo $row['bil_anggota']; ?></div></td>
                                     <td>
                                     <div align="center">
                                      <a href="utama.php?view=admin&action=semak_rumahibadat&id=<?php echo $row['id'];?>"><button type="btn btn-info" class="btn btn-warning btn-circle" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></button></a>
...
$(document).ready(function(){
	...
	$('#insert').on("click", function(event){
	  ...
	  {  
		alert("Name Pengurus tidak dimasukkan!");  
	  }  
	    if($('#no_tel').val() == "")  
	  {  
	    ...
	    if($('#bil_anggota').val() == "")  
	  {  
		alert("Bilangan Anggota tidak dimasukkan!");  
	  }  
	    if($('#nama_rumahibadat').val() == "")  
	  {  
		alert("Nama Rumah Ibadat tidak dimasukkan!");  
	  }  
	    if($('#negeri').val() == "")  
	  {  
