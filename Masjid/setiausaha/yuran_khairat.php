                              ...
                              <?php while($row = mysql_fetch_assoc($result)){ ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $row['alamat_terkini']; ?></td>
                                             <td>
                                             <div align="center"><a href="utama.php?view=setiausaha&action=butirbayaran_khariat&id_data=<?php echo $row['id_data'];?>"><img src="picture/money.png" width="40" height="40"></a>
                           					   </div>
