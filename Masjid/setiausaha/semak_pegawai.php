<div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">BUTIRAN PEGAWAI MASJID</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Maklumat Pegawai Masjid | <button class="btn btn-success" type="button" onclick="history.go(-1)">Kembali</button>
                        </div>
                         <?php 
                      ...
                      <div class="form-group">
                          ...
                          <?php            
$id_pegawai = $_GET['id_data'];

$q = "SELECT gambar FROM data_pegawai_masjid where id_pegawai='$id_pegawai'";
$r = mysql_query("$q",$bd);
if($r)
{
