<div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">DAFTAR ANAK YATIM/PIATU</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            Carian Anak Yatim/Piatu</div>

                        <!-- /.panel-heading -->
                        <div class="panel-body">
                      
                           <div class="table-responsive">
                               <form method="post" id="ibu_tunggal" action="pendaftaran/update_anakyatim.php">          
