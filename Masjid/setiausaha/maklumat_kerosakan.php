                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Carian | <button class="btn btn-success" type="button" onclick="history.go(-1)">Kembali</button></div>
                                    ...
                                    <tbody>
                                     ...
                                     <?php while($row = mysql_fetch_assoc($result)){ ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                             <div align="center"><a href="utama.php?view=setiausaha&action=semak_kerosakan&id_kerosakkan=<?php echo $row['id_kerosakkan'];?>"> <button type="button" class="btn btn-warning btn-circle" data-toggle="tooltip" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></button></a>
                       
                       <div align="center">

                        <form name="delete" method="POST" action="setiausaha/del_kerosakkan.php">
