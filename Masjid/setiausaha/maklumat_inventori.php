                                  ...
                                  <tbody>
                                   ...
                                   <?php while($row = mysql_fetch_assoc($result)){ ?>
                                      <tr class="odd gradeX">
                                          ...
                                          <td><div align="center">
                           					    <a href="utama.php?view=setiausaha&action=susut_nilai&id_inventori=<?php echo $row['id_inventori'];?>&tarikh_belian=<?php echo $row['tahun'];?>"><button type="button" class="btn btn-info btn-circle" data-toggle="tooltip" data-placement="right" title="Lihat">
