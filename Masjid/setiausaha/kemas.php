    ...
    <div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">KEMAS</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Senarai KEMAS&nbsp;&nbsp;
                            <button class="btn btn-info" type="button" data-toggle="modal" data-target="#myModal">Tambah KEMAS </button> &nbsp;&nbsp;
                        ...
                        <div class="panel-body">
						  ...
						  $sql_search="SELECT id,nama_pengurus,no_tel,bil_pelajar,nama_kemas FROM sej6x_data_kemas"; 
						  ...
						  ?>              
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                  <tr>
                                    ...
                                    <th><div align="center">Nama KEMAS</div></th>
                              ...
                              <?php while($row = mysql_fetch_assoc($result)){ ?>
                                    ...
                                    <td><div align="center"><?php echo $row['nama_kemas']; ?></div></td>
                                    ...
                                    <div align="center">
                                      ...
                                      <a href="utama.php?view=admin&action=semak_kemas&id=<?php echo $row['id'];?>"><button type="btn btn-info" class="btn btn-warning btn-circle" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></button>
                                      
                       <form name="delete" method="POST" action="admin/del_kemas.php">
 ...
 <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">DAFTAR KEMAS BARU</h4>
  </div>
  ...
  <h4 align="center"><u>Maklumat Kemas</u></h4>
  <div class="col-lg-6">
    ...
    <div class="form-group">
      ...
      <input class="form-control" name="no_tel" id="no_tel"  placeholder="Contoh: 0121234567"required />
    </div>
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <input class="form-control" name="nama_kemas" id="nama_kemas" required />
    </div>
    </div>
...
$(document).ready(function(){
	...
	$('#insert').on("click", function(event){
	  ...
	  {  
	    ...
	    if($('#nama_kemas').val() == "")  
	  {  
		alert("Nama Kemas tidak dimasukan");  
	  }  
	    if($('#alamat').val() == "")  
	  {  
