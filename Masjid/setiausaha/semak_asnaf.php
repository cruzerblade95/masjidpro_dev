   <div class="row">
                <div class="col-lg-12">
                    <h2 align="center" class="page-header">ASNAF</h2>
                </div>
                <!-- /.col-lg-12 -->
</div>
 <?php 
   ...
   <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Maklumat Asnaf | <button type="button" class="btn btn-success">Kembali</button></div>

                        <div class="panel-body">
							     
                                       <form method="post" id="asnaf" action="setiausaha/kemaskini_asnaf.php">
