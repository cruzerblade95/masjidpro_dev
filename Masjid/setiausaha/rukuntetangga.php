    ...
    <div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">RUKUN TETANGGA</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
						  ...
						  $sql_search="SELECT id,nama_pengurus,no_tel,bil_anggota,nama_rukuntetangga FROM sej6x_data_rukuntetangga"; 
...
$(document).ready(function(){
	...
	$('#insert').on("click", function(event){
	  ...
	  {  
	    ...
	    if($('#nama_rukuntetangga').val() == "")  
	  {  
		alert("Nama Rukuntetangga tidak dimasukan!");  
	  }  
	    if($('#alamat').val() == "")  
	  {  
	  ...
	  {  
		  $.ajax({  
			url:"info/add_rukuntetangga.php",  
			method:"POST",  
