    ...
    <div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">KLINIK</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
						  ...
						  $sql_search="SELECT id,nama_pengurus,no_tel,bil_anggota,nama_klinik FROM sej6x_data_klinik"; 
                       ...
                       <form name="delete" method="POST" action="info/del_klinik.php">
...
$(document).ready(function(){
	...
	$('#insert').on("click", function(event){
	  ...
	  {  
	    ...
	    if($('#nama_klinik').val() == "")  
	  {  
		alert("Nama Klinik tidak dimasukan");  
	  }  
	    if($('#alamat').val() == "")  
	  {  
	    ...
	    if($('#negeri').val() == "")  
	  {  
		alert("Nama Negeri tidak dimasukan");  
	  }  
	    if($('#daerah').val() == "")  
	  {  
		alert("Nama Daerah tidak dimasukan");  
	  }  
	    if($('#poskod').val() == "")  
	  {  
