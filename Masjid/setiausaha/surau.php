    ...
    <div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">SURAU</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Senarai Surau &nbsp;&nbsp;
                            <button class="btn btn-info" type="button" data-toggle="modal" data-target="#myModal">Tambah Surau </button> &nbsp;&nbsp;
                        ...
                        <div class="panel-body">
						  ...
						  $sql_search="SELECT id,nama_pengurus,no_tel,bil_anggota,nama_surau FROM sej6x_data_surau"; 
						  ...
						  ?>              
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                  <tr>
                                    ...
                                    <th><div align="center">Nama Surau</div></th>
                                    <th><div align="center">Pengurus</div></th>
                                    <th><div align="center">No Telefon Pengurus</div></th>
                                    <th><div align="center">Bilangan Ahli Khariah</div></th>
                              ...
                              <?php while($row = mysql_fetch_assoc($result)){ ?>
                                    ...
                                    <td><div align="center"><?php echo $row['nama_surau']; ?></div></td>
                                    ...
                                    <td>
                                      <div align="center">
                                      <a href="utama.php?view=admin&action=semak_surau&id=<?php echo $row['id'];?>"><button type="btn btn-info" class="btn btn-warning btn-circle" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></button>
                                      
                       <form name="delete" method="POST" action="info/del_surau.php">
 ...
 <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">DAFTAR SURAU BARU</h4>
  </div>
  ...
  <div class="col-lg-6">
    ...
    <div class="form-group">
      <label>Bilangan Ahli Kariah</label>
      <input class="form-control" name="bil_anggota" id="bil_anggota" required />
    </div>
     <div class="form-group">
      <label>Nama Surau</label>
      <input class="form-control" name="nama_surau" id="nama_surau" required />
    </div>
    </div>
...
$(document).ready(function(){
	...
	$('#insert').on("click", function(event){
	  ...
	  {  
		alert("Nama Pengurus tidak dimasukkan");  
	  }  
	    	if($('#no_tel').val() == "")  
	  {  
		alert("No.Telefon tidak dimasukkan");  
	   	...
	   	if($('#bil_anggota').val() == "")  
	  {  
		alert("Bilangan Ahli Kariah tidak dimasukkan");  
	  }  
	   	if($('#nama_surau').val() == "")  
	  {  
		alert("Nama Surau tidak dimasukkan");  
	  }  
	   	if($('#alamat').val() == "")  
	  {  
