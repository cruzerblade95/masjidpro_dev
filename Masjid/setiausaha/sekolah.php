    ...
    <div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">SEKOLAH</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Senarai SEKOLAH &nbsp;&nbsp;
                            <button class="btn btn-info" type="button" data-toggle="modal" data-target="#myModal">Tambah Sekolah </button> &nbsp;&nbsp;
                        ...
                        <div class="panel-body">
						  ...
						  $sql_search="SELECT id,nama_pengurus,no_tel,bil_pelajar,nama_sekolah FROM sej6x_data_sekolah"; 
						  ...
						  ?>              
                              ...
                              <?php while($row = mysql_fetch_assoc($result)){ ?>
                                    ...
                                    <td class="center">
                                      ...
                                      <a href="utama.php?view=admin&action=semak_sekolah&id=<?php echo $row['id'];?>"><button type="btn btn-info" class="btn btn-warning btn-circle" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></button>
                                      
                       <form name="delete" method="POST" action="admin/del_sekolah.php">
 ...
 <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">DAFTAR SEKOLAH BARU</h4>
  </div>
  ...
  <h4 align="center"><u>Maklumat Sekolah</u></h4>
  <div class="col-lg-6">
...
$(document).ready(function(){
	...
	$('#insert').on("click", function(event){
	  ...
	  {  
	   ...
	   if($('#nama_sekolah').val() == "")  
	  {  
		alert("Nama Sekolah tidak dimasukkan!");  
	  }  
	   if($('#alamat').val() == "")  
	  {  
	  ...
	  {  
	   ...
	   if($('#bil_pelajar').val() == "")  
	  {  
		alert("Bilangan Pelajar tidak dimasukkan!");  
	  }    
	  else  
	  {  
		  $.ajax({  
			url:"info/add_sekolah.php",  
			method:"POST",  
