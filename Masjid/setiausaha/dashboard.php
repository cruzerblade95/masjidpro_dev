...
<!-- div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-info">
                        ...
                        <a href="utama.php?view=setiausaha&action=senarai_ajk">
                            <div class="panel-footer">
                                <span class="pull-left">Semak</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-info">
                        ...
                        ?>
                        <a href="utama.php?view=setiausaha&action=senarai_pegawai">
                            <div class="panel-footer">
                                <span class="pull-left">Semak</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-info">
                        ...
                        <a href="utama.php?view=setiausaha&action=maklumatinventori">
                            <div class="panel-footer">
                                <span class="pull-left">Semak</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
           ...
           <!-- second line-->
                ...
                ?>
                        <a href="utama.php?view=setiausaha&action=maklumatkerosakan">
                            <div class="panel-footer">
                                <span class="pull-left">Semak</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
