<div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">DAFTAR LAYAK UNDI</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Carian | <button  type="button" class="btn btn-success" onclick="history.go(-1)">Kembali</button></div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            Maklumat Layak Undi</div>

                        <!-- /.panel-heading -->
                        <div class="panel-body">
                      
                           <div class="table-responsive">
                               <form method="post" id="layak_mengundi" action="setiausaha/update_mengundi.php">          
