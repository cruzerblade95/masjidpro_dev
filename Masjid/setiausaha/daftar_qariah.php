                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <button class="btn btn-success" type="button" data-toggle="modal" data-target="#myModal">Tambah Ahli </button> | <button class="btn btn-success" type="button" onclick="history.go(-1)">Kembali</button>
                    ...
                    <a href="utama.php?view=setiausaha&action=view_ahliqariah&id_data=<?php echo $row['id_data'];?>"><button type="button" class="form-control" title="Kemaskini"><i class="glyphicon glyphicon-edit"></i></button></a><br>
                            				 
                       <form name="delete" method="POST" action="setiausaha/del_ahlikariah.php">
                       <input type="hidden" name="del" id="del" value="<?php echo $row['id_data']; ?>">

                       <button type="submit" name="delete" id="delete" class="form-control"  title="Padam" onclick="return confirm('Padam Rekod?');"><i class="glyphicon glyphicon-remove" ></i></button></form>                   	
                                    </td>
                                    </tr>
                                        <?php 
											$x++; } 
