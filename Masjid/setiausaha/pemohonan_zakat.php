<div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">PEMOHONAN ZAKAT</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
<div class="row">
 ...
 <?php 
              ...
              <div align="center"><a href="utama.php?view=butiran_zakat&id_data=<?php echo $row['id_data'];?>"><input type="button" value="Mohon" class="btn btn-success" /></a></div> 
