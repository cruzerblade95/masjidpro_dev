                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Carian |  <button type="button" onclick="history.go(-1)" class="btn btn-success">Kembali</button></div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
						  ...
						  ?>  
                               ...
                               <form method="post" id="ibu_tunggal" action="setiausaha/update_asnaf.php">               	                               
