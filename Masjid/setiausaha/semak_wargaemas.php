   <div class="row">
                <div class="col-lg-12">
                    <h2 align="center" class="page-header">WARGAEMAS</h2>
                </div>
                <!-- /.col-lg-12 -->
</div>
 <?php 
   ...
   <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Maklumat Warga Emas | | <button type="button" class="btn btn-success">Kembali</button></div></div>

                        <div class="panel-body">
							     
                                       <form method="post" id="warga emas" action="setiausaha/sql_update_wargaemas.php">
