                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <?php while($row = mysql_fetch_assoc($result)){ ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                            <div align="center"><a href="utama.php?view=admin&action=semak_utiliti&id_utiliti=<?php echo $row['id_utiliti'];?>"> <button type="button" class="btn btn-warning btn-circle" data-toggle="tooltip" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></button></a>
                       
                       <div align="center"><form name="delete" method="POST" action="admin/del_utiliti.php">
