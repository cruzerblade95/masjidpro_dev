<?php
	...
	$sql="SELECT * FROM sej6x_data_masjid WHERE daerah='$daerah' AND jenis_masjid='MASJID MUKIM / KARIAH'";
	$sqlquery=mysqli_query($bd2, $sql);
	$row = mysqli_num_rows($sqlquery);

?>
<h4><u><?php echo $daerah; ?></u></h4>
<br>
<div class="table-responsive">          
	<table class="table">
		...
		if($row==0){
			?>
			<tr>
				<td align="center" colspan="4">*Tiada Masjid Berdaftar Dengan MasjidPro*</td>
			</tr>	
			<?
		}
		else if($row>0)
