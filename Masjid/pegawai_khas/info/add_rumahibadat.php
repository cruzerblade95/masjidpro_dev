...
if(!empty($_POST))
{
	...
	$sql1 ="INSERT INTO sej6x_data_rumahibadat(id,id_masjid, nama_pengurus, no_tel,nama_rumahibadat,bil_anggota, alamat, negeri, 
...
$test=mysql_query($sql1, $bd);
	if($test)
	{
		    header("location: ../utama.php?view=rumahibadat"); 
	}
	else
	{
		echo mysql_error();
