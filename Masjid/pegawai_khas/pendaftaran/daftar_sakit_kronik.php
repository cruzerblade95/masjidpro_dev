<div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">DAFTAR SAKIT KRONIK</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
<div class="row">
 ...
 <?php 
              ...
              <div align="center"><a href="utama.php?view=butiran_sakit&id_data=<?php echo $row['id_data'];?>"><input type="button" value="Daftar" class="btn btn-success" /></a></div> 
