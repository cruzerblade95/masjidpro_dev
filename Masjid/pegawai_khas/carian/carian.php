...
<div class="panel-heading">
		...
		if ($nama==1){
			...
			$sql_search="SELECT nama_penuh,no_ic,tarikh_lahir,no_hp,alamat_terkini,jantina
		FROM sej6x_data_peribadi where nama_penuh LIKE '%$nama%'"; 
		 ...
		 include("excel/ahli_kariah.php");
	     $sql_search=" SELECT nama_penuh,no_ic,tarikh_lahir,no_hp,alamat_terkini,jantina,pekerjaan
		 ...
		 include("excel/ahli_kariah.php");
		 $sql_search="SELECT nama_penuh,no_ic,tarikh_lahir,no_hp,alamat_terkini,jantina,zon_qariah
		...
		FROM sej6x_data_peribadi where status_perkahwinan ='$status_perkahwinan' ";
 		...
 		include("excel/ahli_kariah.php");
		$sql_search="SELECT nama_penuh,no_ic,tarikh_lahir,no_hp,alamat_terkini,jantina,umur
		FROM sej6x_data_peribadi
