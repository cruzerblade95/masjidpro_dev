   <div class="row">
                <div class="col-lg-12">
                    <h2 align="center" class="page-header">ANAK YATIM / PIATU</h2>
                </div>
                <!-- /.col-lg-12 -->
</div>
 <?php 
   ...
   <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Maklumat Anak Yatim / Piatu</div>

                        <div class="panel-body">
							     
                                       <form method="post" id="anak yatim" action="pendaftaran/kemaskini_anakyatim.php">
