						  ...
						  ?>  
                               ...
                               <form method="post" id="ajkmasjid" action="">          
                                <table class="table table-striped table-bordered table-hover">
	    						    ...
	    						    <div align="center"><a href="utama.php?view=butiran_jawatanajk&id_data=<?php echo $row['id_data'];?>"><input type="button" value="Daftar" class="btn btn-success" /></a></div>  
                                            </td>
