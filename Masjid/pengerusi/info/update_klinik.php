...
include("../connection/connection.php");
	...
	$sql1 ="UPDATE sej6x_data_klinik set nama_pengurus='$nama_pengurus',no_tel='$no_tel',bil_anggota=$bil_anggota,
	nama_klinik='$nama_klinik',alamat='$alamat',negeri='$negeri',daerah='$daerah',poskod=$poskod  
	 where id='$id' ";

    $test=mysql_query($sql1, $bd);
	if($test)
	{
		    header("location: ../utama.php?view=klinik"); 
	}
	else
	{
		echo mysql_error();
