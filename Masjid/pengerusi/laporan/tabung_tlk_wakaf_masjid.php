            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Tabung TLK Wakaf Masjid</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Tabung TLK Wakaf Masjid</h4>
                                        </div>
                                        <div class="modal-body">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="panel panel-info">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            <h4 align="center"><u>Maklumat Tabung TLK Wakaf Masjid</u></h4>
