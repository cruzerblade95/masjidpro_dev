    ...
    <div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">PASTI</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Senarai PASTI
                            <button class="btn btn-info" type="button" data-toggle="modal" data-target="#myModal">Tambah PASTI </button>                   </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
						  ...
						  $sql_search="SELECT id,nama_pengurus,no_tel,bil_pelajar,nama_pasti FROM sej6x_data_pasti"; 
						  ...
						  ?>              
                              ...
                              <?php while($row = mysql_fetch_assoc($result)){ ?>
                                    ...
                                    <td class="center">
                                      ...
                                      <a href="utama.php?view=semak_pasti&id=<?php echo $row['id'];?>"><button type="btn btn-info" class="btn btn-warning btn-circle" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></button>
                                      
                       <form name="delete" method="POST" action="info/del_pasti.php">
                       <input type="hidden" name="del" id="del" value="<?php echo $row['id']; ?>">
                       <button type="submit" name="delete" id="delete" class="btn btn-danger btn-circle" data-toggle="tooltip" data-placement="right" title="Padam"><i class="fa fa-times"></i></button></form>
                                      </td>
                                  </tr>
                                   <?php 
	...
	$('#insert').on("click", function(event){
	  ...
	  {  
		alert("Nama Pengurus tidak dimasukan");  
	       ...
	       if($('#nama_pasti').val() == "")  
	  {  
		alert("Nama Pasti tidak dimasukan");  
	  }  
