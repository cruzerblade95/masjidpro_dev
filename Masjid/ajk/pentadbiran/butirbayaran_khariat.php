            ...
            <div class="col-lg-12">
                ...
                <!-- /.col-lg-12 -->
                  <?php 
						  ...
						  id_ajk,nama_penuh,no_ic,no_tel FROM sej6x_data_ajkmasjid "; 
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                      ...
                      <form method="POST" action="pentadbiran/add_yurankhariat.php" name="yuran_khariat">  
                 ...
                 <input class="form-control" type="hidden" name="id_data" value="<?php echo $row['id_data'];?>">                 <input class="form-control" type="hidden" name="id_jenisbayaran" value="2">
