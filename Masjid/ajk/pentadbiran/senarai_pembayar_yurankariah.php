                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                      ...
                                      <tr class="odd gradeX">
                                            ...
                                            <td><div align="center"> 
							 <?php if(!$_GET['jenis']) { ?>
   <a href="utama.php?view=terima_bayaran_terperinci&id_bayaran=
				             <?php echo($row['id_bayaran']);?>&id_data=<?php echo($row['id_data']); ?>">[Cetak Resit]</a><?php } ?>
                             
                          <?php if($_GET['jenis'] == "wakaf") { ?>
   <a href="utama.php?view=terima_bayaran_terperinci&jenis=wakaf&id_bayaran=
				             <?php echo($row['id_bayaran']);?>&id_data=<?php echo($row['id_data']); ?>">[Cetak Resit]</a><?php } ?>
                             
                           <?php if($_GET['jenis'] == "zakat") { ?>
   <a href="utama.php?view=terima_bayaran_terperinci&jenis=zakat&id_bayaran=
				             <?php echo $row['id_bayaran'];?>&id_data=<?php echo($row['id_data']); ?>">[Cetak Resit]</a><?php } ?>
