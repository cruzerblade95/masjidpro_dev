<div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">NIKAH</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            <td>1</td>
                                            <td>MUHAMMAD SULAIMAN BIN HASSAN</td>
                                            <td>120828-02-5235</td>
                                            <td class="center">6</td>
                                            <td class="center">34 LORONG 3/12 JALAN KAMPUNG BARU</td>
                                             <td>
                                        ...
                                        <tr class="odd gradeX">
                                            <td>2</td>
                                            <td>SITI FASIHAH BINTI ABU BAKAR</td>
                                            <td>780528-02-5233</td>
                                            <td ="center">40</td>
                                            <td class="center">34 LORONG 3/12 JALAN KAMPUNG BARU</td>
                                             <td>
                                             	<button type="button" class="btn btn-danger btn-circle" data-toggle="tooltip" data-placement="right" title="Padam">
                                        ...
                                        <tr class="odd gradeX">
                                            <td>4</td>
                                            <td>MUHAMMAD SAJAT BIN KASNON</td>
                                            <td>780528-02-5233</td>
                                        ...
                                        <tr class="odd gradeX">
                                            <td>5</td>
                                            <td>MUHAMMAD DON BIN DANIYAL</td>
                                            <td>780528-02-5233</td>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">BORANG DAFTAR NIKAH</h4>
                                        </div>
                                        <div class="modal-body">
							                ...
							                <div class="col-lg-12">
							                    <div class="panel panel-info">
							                       <!--  <div class="panel-heading">
							                        ...
							                        <div class="panel-body">
							                            ...
							                            <div class="row">
							                            	<h4 align="center"><u>Maklumat Nikah</u></h4>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <div class="form-group">
                                                                    <label>Belanja Hantaran</label>
                                                                    <t <input class="form-control" required>   
                                                                </div>
                                                ...
                                                <div class="panel-body">
                                                        <div class="row">
                                                            <h4 align="center"><u>Maklumat Pengantin Lelaki</u></h4>
                                                ...
                                                <div class="panel-body">
                                                        <div class="row">
                                                            <h4 align="center"><u>Maklumat Pengantin Perempuan</u></h4>
                                            ...
                                            <div class="panel-body">
                                                        <div class="row">
                                                            <h4 align="center"><u>Maklumat Wali</u></h4>
                                            ...
                                            <div class="panel-body">
                                                        <div class="row">
                                                            <h4 align="center"><u>Maklumat Saksi Pertama</u></h4>
                                            ...
                                            <div class="panel-body">
                                                        <div class="row">
                                                            <h4 align="center"><u>Maklumat Saksi Kedua</u></h4>
                                            ...
                                            <div class="panel-body">
                                                        <div class="row">
                                                            <h4 align="center"><u>Pengesahan Pihak Masjid</u></h4>
