                              ...
                              <?php while($row = mysql_fetch_assoc($result)){ ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $row['alamat_terkini']; ?></td>
                                             <td><div align="center">
                                              <a href="utama.php?view=kemaskini_layakmengundi&id_data=<?php echo $row['id_data'];?>"><button type="button" class="btn btn-warning btn-circle" data-toggle="tooltip" data-placement="right" title="Edit">
                            					 	<i class="fa fa-pencil"></i>
                            					 </button></a>
                                             	 <form name="delete" method="POST" action="pendaftaran/del_layakmengundi.php">
