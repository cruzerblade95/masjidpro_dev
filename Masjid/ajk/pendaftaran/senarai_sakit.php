    ...
    <div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">SENARAI PESAKIT KRONIK</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
            <!-- /.row -->
            <?Php
              $sql_search="SELECT id_data,nama_penuh,no_ic,umur,alamat_terkini,no_hp 
						   FROM sej6x_data_peribadi where data_sakit=1"; 
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                      ...
                                      <tr class="odd gradeX">
                                            ...
                                            <td><div align="center"><a href="utama.php?view=semak_sakit&id_data=<?php echo $row['id_data'];?>">[Semak]</a></div></td>
