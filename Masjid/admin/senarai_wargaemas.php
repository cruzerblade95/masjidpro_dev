		...
		<div class="page-header float-right">
			<div class="page-title">
				<ol class="breadcrumb text-right">
					...
					<li><a href="utama.php?view=admin&action=daftar_warga_emas">Daftar Warga Emas</a></li>
					<li class="active">Senarai Warga Emas</li>
				</ol>
			</div>
		</div>
	</div>
		...
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body">
					...
					include("excel/excel_wargaemas.php");
					
					$sql_search="SELECT * FROM sej6x_data_peribadi where id_masjid='$id_masjid' AND warga_emas=1"; 
					...
					<b>Klik Icon
					<?php
					$path = "output/".$kod_masjid."/SenaraiWargaEmas.xlsx";
					?> 
						...
						<table id="bootstrap-data-table-export" class="table table-striped table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div align="center">
											<form action="admin/del_wargaemas.php" method="POST">
					...
					include("excel/excel_wargaemas_t.php");
					...
					<b>Klik Icon
					<?php
					$pathT = "output/".$kod_masjid."/SenaraiWargaEmasTanggungan.xlsx";
					?> 
