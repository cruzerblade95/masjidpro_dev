<?php 
	...
	$idd = $_GET['id'];
	$sql_search="SELECT 
	id,id_masjid, nama_pengurus, no_tel,nama_kafa,bil_pelajar, alamat, negeri, 
	daerah,poskod
	...
	if($r)
	{
		while($row=mysql_fetch_array($r))
		{
			...
			$sql_zonkariah="SELECT id_zonqariah,id_masjid,nama_zon,no_huruf FROM sej6x_data_zonqariah WHERE id_masjid='$id_masjid'"; 	                      $sql_zon=mysql_query($sql_zonkariah) or die ("Error :".mysql_error());
?>
		...
		<div class="page-header float-right">
			<div class="page-title">
				<ol class="breadcrumb text-right">
					...
					<li><a href="utama.php?view=admin&action=kafa">KAFA</a></li>
					<li class="active">Semak KAFA</li>
				</ol>
			</div>
		</div>
	</div>
...
<div class="content mt-3">
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">Maklumat Kafa</div> 
				<div class="card-body">
					<form method="post" action="admin/update_kafa.php" name="kafa">
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<input class="form-control" name="nama_kafa" id="nama_kafa" value="<?php echo $row['nama_kafa'];?>" required />
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
