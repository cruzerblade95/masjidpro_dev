                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
						  ...
						  $sql_search="SELECT id,nama_pengurus,no_tel,bil_anggota,nama_persatuan FROM sej6x_data_persatuan WHERE id_masjid='$id_masjid'"; 
						  ...
						  ?>              
                              ...
                              <?php while($row = mysql_fetch_assoc($result)){ ?>
                                    ...
                                    <td class="center"><div align="center"><?php echo $row['bil_anggota']; ?></div></td>
                                     <td>
										<div align="center">
											<a href="utama.php?view=admin&action=semak_persatuan&id=<?php echo $row['id'];?>">
					...
					<div class="col-lg-12">
						<div class="panel panel-info">
							<div class="panel-body">
								<form method="post" id="insert_form" action="admin/add_persatuan.php">
									<div class="row">
										<div class="col-lg-12">
...
<script>
    jQuery(document).ready(function () {
        meja_akaun('#meja_akaun2', 'Senarai Persatuan', [ 0, 1, 2, 3, 4 ]);
    });
</script>
