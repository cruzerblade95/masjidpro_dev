        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    Maklumat Ahli &nbsp;&nbsp;
                    <a href="utama.php?view=admin&action=semakorganisasi&sideMenu=organisasi"><button  class="btn btn-info">Kembali </button></a>
                </div>
                <?php

                include("connection/connection.php");

                $idorg = $_GET['idorganisasi'];

                $semak_rekod = "SELECT * FROM rekod_organisasi WHERE id = $idorg";
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div>
                                <label style="text-align: center; font-size: medium; font-weight: normal">Alamat E-mel : <?php echo $r_result['emel'];?> </label>
                            </div>
                        </div>
                    </div>
                    <hr>
                            ...
                            <div class="row">
                                <div class="table-responsive">
                                    <table id="senarai_semakrekod" width="100%" data-order="[]" class="table table-bordered table-striped">
                                        ...
                                        $idorg2 =  $r_result['no_pengenalan'];
                                        $list_j="SELECT id, jawatan, tarikh_lantikan, tarikh_perletakan FROM rekod_organisasi WHERE id_masjid = $id_masjid AND no_pengenalan LIKE '%$idorg2%' $susun ";
                                        ...
                                        while($row = mysqli_fetch_assoc($r_list))
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><div align="center"><?php echo strtoupper($row['jawatan']); ?></td>
...
<script>
    jQuery(document).ready(function () {
        meja_akaun('#senarai_semakrekod', 'Butiran Ahli Organisasi Masjid', [ 0, 1, 2, 3 ]);
    });
</script>