...
if(!empty($_POST))
{
	...
	$nama_klinik=mysqli_real_escape_string($bd2, $_POST['nama_klinik']);
	...
	$sql1 ="INSERT INTO sej6x_data_klinik(id_masjid, nama_pengurus, no_tel,nama_klinik,bil_anggota, alamat, negeri, 
