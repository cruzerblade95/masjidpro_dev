...
if(!empty($_POST))
{
	...
	$nama_kemas=mysqli_real_escape_string($bd2, $_POST['nama_kemas']);
	...
	$sql1 ="INSERT INTO sej6x_data_kemas(id_masjid, nama_pengurus, no_tel,nama_kemas,bil_pelajar, alamat, negeri, 
