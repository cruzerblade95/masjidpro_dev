...
<center>
    <div class="col-12">
        <form action="admin/edit_tetapankehadiranajk.php" method="POST" onSubmit="return confirm('Pastikan Maklumat Betul')">
            <div class="row">
                ...
                <div class="col-4 offset-4">
                    <center>
                        ...
                        <button class="btn-success btn" type="submit" name="updateTetapan_ajk">Kemaskini</button>
                    </center>
                </div>
                <?php }?>
            </div>
