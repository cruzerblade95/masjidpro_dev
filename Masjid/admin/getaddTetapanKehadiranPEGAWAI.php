...
<center>
    <div class="col-12">
        <form action="admin/add_tetapankehadiranpegawai.php" method="POST" onSubmit="return confirm('Pastikan Maklumat Betul')">
            <div class="row">
                <div class="col-12">
                    <div class="form-body">
                ...
                <div class="col-4 offset-4">
                    <center>
                        ...
                        <button class="btn-success btn" type="submit" name="tambahTetapan_pegawai">Tambah</button>
                    </center>
                </div>
            </div>
        </form>
