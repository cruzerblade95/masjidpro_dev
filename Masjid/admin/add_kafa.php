...
// Connect to server and select database.
	...
	$nama_kafa=mysqli_real_escape_string($bd2, $_POST['nama_kafa']);
	...
	$sql1 ="INSERT INTO sej6x_data_kafa(id_masjid, nama_pengurus, no_tel,nama_kafa,bil_pelajar, alamat, negeri, 
	        daerah,poskod,last_added)
			VALUES($id_masjid,'$nama_pengurus','$no_tel','$nama_kafa',$bil_pelajar,'$alamat','$negeri',
			'$daerah',$poskod,NOW())";
