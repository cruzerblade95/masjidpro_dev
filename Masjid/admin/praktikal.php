...
$sql_search="SELECT * FROM sej6x_data_praktikal WHERE id_masjid='$id_masjid' AND status=1";
    ...
    <div class="col-sm-4">
        <div class="page-header float-left">
            <div class="page-title">
                <h1>Senarai Pelajar Praktikal</h1>
            </div>
        </div>
    </div>
    <div class="col-sm-8">
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    <li class="active">Senarai Pelajar Praktikal</li>
                    <li><a href="utama.php?view=admin&action=rekod_praktikal">Rekod Pelajar Praktikal</a></li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        <table id="table_display" class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <th width="12%"><div align="center">Tarikh Mula</div></th>
                                <th width="12%"><div align="center">Tarikh Tamat</div></th>
                            ...
                            else if($row>0)
                            {
                                ...
                                while($row = mysql_fetch_assoc($result))
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><?php echo $row['tarikh_mula']; ?></td>
                                        <td align="center"><?php echo $row['tarikh_tamat']; ?></td>
                                        <td align="center">
