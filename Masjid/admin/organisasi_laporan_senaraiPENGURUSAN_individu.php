        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    <li><a href="utama.php?view=admin&action=organisasi_laporan_senaraiPENGURUSAN&sideMenu=organisasi">Menu Kehadiran</a></li>
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-2" align="end">
                            <a href="utama.php?view=admin&action=organisasi_laporan_senaraiPENGURUSAN&sideMenu=organisasi"><button class="btn btn-primary">Kembali</button></a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                ...
                <div class="card-body" id="div_print">
                    <div class="table-responsive">
                        ...
                        $sql_search = "SELECT c.id 'id_pengurusan', c.nama_penuh, c.no_pengenalan 'no_ic', c.no_telefon 'no_tel', c.jawatan FROM rekod_organisasi c WHERE c.id = '$id' AND c.jawatan = '$jawatan' UNION SELECT a.id_pengurusan, a.nama_penuh, a.no_ic, a.no_tel, b.jawatan FROM data_pengurusan_masjid a, jawatan_pengurusan_masjid b WHERE a.jawatan=b.id_jawatan AND a.id_pengurusan='$id'";
