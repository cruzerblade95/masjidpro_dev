...
if(!empty($_POST))
{
	...
	$nama_sekolah=mysqli_real_escape_string($bd2, $_POST['nama_sekolah']);
	...
	$sql1 ="INSERT INTO sej6x_data_sekolah(id_masjid, nama_pengurus, no_tel,nama_sekolah,bil_pelajar, alamat, negeri,daerah,poskod,last_added)
			   		VALUES($id_masjid,'$nama_pengurus','$no_tel','$nama_sekolah',$bil_pelajar,'$alamat','$negeri',
			'$daerah',$poskod,NOW())";

$test=mysqli_query($bd2, $sql1);
	if($test)
	{
		    header("location: ../utama.php?view=admin&action=sekolah"); 
	}
	else
	{
