    ...
    <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 align="center" class="page-header">PEMBAYARAN WAKAF</h1><?php } ?>
                     <!--Zakat-->
                    <?php if($_GET['jenis'] == "zakat") { ?>
                    <h1 align="center" class="page-header">PEMBAYARAN ZAKAT</h1><?php } ?>
                     <!--Yuran Kariah-->
                    <?php if(!$_GET['jenis']) { ?>
                    <h1 align="center" class="page-header">YURAN AHLI KARIAH</h1><?php } ?>
                </div>
                <!-- /.col-lg-12 -->
</div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
						  ...
						  $sql_search="SELECT id_data,nama_penuh,no_ic,umur,alamat_terkini FROM sej6x_data_peribadi ORDER BY nama_penuh ASC"; 
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $row['alamat_terkini']; ?></td>
                                             ...
                                             <div align="center">
                                                <!--Wakaf-->
                                                 <?php if($_GET['jenis'] == "wakaf") { ?>
                                                 <a href="utama.php?view=butirbayaran_kariah&jenis=wakaf&id_data=<?php echo $row['id_data'];?>"><img src="picture/money.png" width="40" height="40"></a>
                                                 <?php } ?>
                                             
                                                 <!--Zakat-->
                                                 <?php if($_GET['jenis'] == "zakat") { ?>
                                                 <a href="utama.php?view=butirbayaran_kariah&jenis=zakat&id_data=<?php echo $row['id_data'];?>"><img src="picture/money.png" width="40" height="40"></a>
                                                 <?php } ?>
                                                  <!--Yuran Kariah-->
                                                 <?php if(!$_GET['jenis']) { ?>
                                                 <a href="utama.php?view=butirbayaran_kariah&id_data=<?php echo $row['id_data'];?>"><img src="picture/money.png" width="40" height="40"></a>
                                                 <?php } ?>
                           					   </div>
