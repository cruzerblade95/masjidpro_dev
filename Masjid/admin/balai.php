                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
						  ...
						  $sql_search="SELECT id,nama_pengurus,no_tel,bil_anggota,nama_balai FROM sej6x_data_balai WHERE id_masjid='$id_masjid'"; 
					...
					<div class="col-lg-12">
						<div class="panel panel-info">
							<div class="panel-body">
								<form method="post" id="insert_form" action="admin/add_balai.php">
									<div class="row">
										<div class="col-lg-12">
...
<script>
    jQuery(document).ready(function () {
        meja_akaun('#meja_akaun2', 'Senarai Balai', [ 0, 1, 2, 3, 4 ]);
    });
</script>
