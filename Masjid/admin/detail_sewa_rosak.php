   ...
   $abc="SELECT * FROM maklumat_sewaan where sewa_rujukan='".$idd."' ";
...
<div class="row">
            <div class="col-lg-12">
              <h1  align="center" class="page-header">BARANG SEWAAN ROSAK</h1>
            </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <div class="col-lg-4">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="sewa_baki_bayaran" value="<?php echo $row['sewa_baki_bayaran']; ?>" readonly>
                                        </div>
				   ...
				   <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="catatan" readonly><?php echo $row['sewa_catatan']; ?></textarea> 
                                    </div>                                        
 ...
 <button class="btn btn-primary" type="submit" onclick="history.go(-1);">Kembali </button>
