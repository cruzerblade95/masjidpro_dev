		...
		<div class="page-header float-right">
			<div class="page-title">
				<ol class="breadcrumb text-right">
					...
					<li class="active">Menu Jenis Perbelanjaan</li>
				</ol>
			</div>
		</div>
	</div>
		...
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">
					...
					<button class="btn btn-success" type="button" data-toggle="modal" data-target="#myModal">Tambah Jenis Perbelanjaan</button>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
				</div>
				<!-- /.panel-heading -->
				<div class="card-body">
						...
						<table id="bootstrap-data-table-export" class="table table-striped table-bordered">
							<thead>
								<tr>
									...
									<th width="57%"><div align="center">Nama Perbelanjaan</div></th>
							...
							<tbody>
								...
								$i=1;
								$sql="SELECT * FROM sej6x_data_jenisbayaran WHERE id_masjid='$id_masjid' ORDER BY kategori ASC";
								...
								<tr>
									...
									<td align="center"><?php echo $data['nama_bayaran']; ?></td>
									<td align="center">
									<?php 
									...
									<td align="center"><a href="utama.php?view=admin&action=sumbangan&id_bayaran=<?php echo $data['id_bayaran']; ?>" class="btn btn-warning btn-sm btn-block"><i class="far fa-money-bill-alt"></i><br>Bayaran</a></td>
								</tr>
									<?php
									$i++;
									}
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="myModalLabel">TAMBAH JENIS PERBELANJAAN</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>
					<div class="modal-body">
						<div class="row">
							<div class="col-lg-12">
								<form method="post" id="insert_form" action="admin/add_jenis_bayaran.php">
								<center>          
								<div class="row">
									<div class="col-lg-12">
										<center><h4><u>Maklumat Jenis Perbelanjaan</u></h4></center>
									</div>
								</div>
								<hr>
								<div class="row">
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											<label style="color: red">*</label><b>Nama Perbelanjaan</b>
											<input class="form-control" name="nama_bayaran" id="nama_bayaran" required>
										</div>
									</div>
								</div>
								<!-- /.row (nested) -->
