    ...
    <div class="form-body">
        ...
        <div class="form-group row">
            <div class="col-md-12">
                <center>
                <?php
                if($data_wakaf['gambar_qr']==NULL OR $data_wakaf['gambar_qr']==''){
                ?>
                *Tiada QR Code*
                <?php
                }
                else if($data_wakaf['gambar_qr']!=NULL OR $data_wakaf['gambar_qr']!=''){
                ?>
                <img width='750px' height='750px' src="<?php echo $data_wakaf['gambar_qr']; ?>">
                <?php
                }
                ?>
                </center>
