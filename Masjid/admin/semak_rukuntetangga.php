		...
		<div class="page-header float-right">
			<div class="page-title">
				<ol class="breadcrumb text-right">
					...
					<li><a href="utama.php?view=admin&action=rukuntetangga">Rukun Tetangga</a></li>
					<li class="active">Semak Rukun Tetangga</li>
				</ol>
			</div>
		</div>
	</div>
...
<div class="content mt-3">
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">Maklumat Rukun Tetangga</div> 
				<div class="card-body">
