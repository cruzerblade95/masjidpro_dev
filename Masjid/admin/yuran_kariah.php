                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $row['alamat_terkini']; ?></td>
                                             ...
                                             <div align="center">
                                                <!--Wakaf-->
                                                 <?php if($_GET['jenis'] == "wakaf") { ?>
                                                 <a href="utama.php?view=admin&action=butirbayaran_kariah&jenis=wakaf&id_data=<?php echo $row['id_data'];?>"><img src="picture/money.png" width="40" height="40"></a>
                                                 <?php } ?>
                                             
                                                 <!--Zakat-->
                                                 <?php if($_GET['jenis'] == "zakat") { ?>
                                                 <a href="utama.php?view=admin&action=butirbayaran_kariah&jenis=zakat&id_data=<?php echo $row['id_data'];?>"><img src="picture/money.png" width="40" height="40"></a>
                                                 <?php } ?>
                                                  <!--Yuran Kariah-->
                                                 <?php if(!$_GET['jenis']) { ?>
                                                 <a href="utama.php?view=admin&action=butirbayaran_kariah&id_data=<?php echo $row['id_data'];?>"><img src="picture/money.png" width="40" height="40"></a>
                                                 <?php } ?>
                           					   </div>
