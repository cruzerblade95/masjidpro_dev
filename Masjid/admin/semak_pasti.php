		...
		<div class="page-header float-right">
			<div class="page-title">
				<ol class="breadcrumb text-right">
					...
					<li><a href="utama.php?view=admin&action=pasti">Pasti</a></li>
					<li class="active">Semak Pasti</li>
				</ol>
			</div>
		</div>
	</div>
...
<div class="content mt-3">
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">Maklumat Pasti</div> 
				<div class="card-body">
					<form method="post" action="admin/update_pasti.php" name="pasti">
					<div class="row">
						<div class="col-lg-6">
