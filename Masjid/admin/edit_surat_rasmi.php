        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    <li class="active">Kemaskini Surat Rasmi</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form name="add_surat" id="add_surat" action="admin/update_surat_rasmi.php" method="post" class="form-validate form-horizontal well form-element2" enctype="multipart/form-data">
                            <?php if($jenis_surat != NULL) { ?>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            <div class="col-12 col-md-12">
                                                ...
                                                <input id="tajuk_surat" name="tajuk_surat" required aria-required="true" placeholder="Tajuk Surat (Perkara)" class="form-control" value="<?php echo $r1['tajuk_surat']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            <div class="col-12 col-md-6">
                                                ...
                                                <input class="form-control required" id="penerima" name="penerima" required aria-required="true" value="<?php echo $r1['penerima']; ?>">
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <label>Alamat 1:</label>
                                                <input class="form-control" id="alamat_1" name="alamat_1" value="<?php echo $r1['alamat_1']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-12 col-md-6">
                                                <label>Alamat 2:</label>
                                                <input class="form-control" id="alamat_2" name="alamat_2" value="<?php echo $r1['alamat_2']; ?>">
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <label>Alamat 3:</label>
                                                <input class="form-control" id="alamat_3" name="alamat_3" value="<?php echo $r1['alamat_3']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-12 col-md-2">
                                                <label>Poskod:</label>
                                                <input class="form-control" id="poskod" name="poskod" maxlength="5" type="number" step="1" value="<?php echo $r1['poskod']; ?>">
                                            </div>
                                            <div class="col-12 col-md-5">
                                                <label>Bandar:</label>
                                                <input class="form-control" id="bandar" name="bandar" value="<?php echo $r1['bandar']; ?>">
                                            </div>
                                            <div class="col-12 col-md-5">
                                                <label>Negeri</label>
                                                <select class="form-control" id="id_negeri" name="id_negeri">
                                                    ...
                                                    {
                                                        ?>
                                                        <option value="<?php echo $data_negeri['id_negeri']; ?>" <?php if($r1['id_negeri']==$data_negeri['id_negeri']) { echo "selected"; } ?>><?php echo $data_negeri['name']; ?></option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <?php if($jenis_surat == 2){ ?>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <input required class="form-control required" id="tarikh_majlis" name="tarikh_majlis" type="date" aria-required="true" value="<?php echo $r1['tarikh_majlis']; ?>">
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <label>* Masa</label>
                                                    <input required class="form-control required" id="masa" name="masa" type="time" aria-required="true" value="<?php echo $r1['masa']; ?>">
                                                </div>
                                                <div class="col-12 col-md-12">
                                                    <label>* Tempat</label>
                                                    <input type="hidden" value="2" name="id_isi[]">
                                                    <input required class="form-control required" name="isi_surat[]" type="text" aria-required="true" value="<?php echo($myJSON[0]['isi_surat']); ?>">
                                                </div>
                                            </div>
                                            <?php if($jenis_surat == 2) { ?>
                                                <div class="form-group row">
                                                    <div class="col-12 col-md-12">
                                                        ...
                                                        <input class="form-control" name="isi_surat[]" type="text" value="<?php echo($myJSON[1]['isi_surat']); ?>">
                                                    </div>
                                                </div>
                                            <?php } ?>
                                        <?php } ?>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12 col-md-12">
                                                <?php if($jenis_surat == 1) { ?>
                                                    <label>Berhubung dengan perkara di atas saya selaku wakil <?php echo ucwords(strtolower($data_masjid['nama_masjid'])); ?> Ingin membuat aduan kepada pihak tuan bagi  menyiasat, memantau dan mengambil tidakan yang sewajarnya.</label>
                                                <?php } ?>
                                                <?php if($jenis_surat == 2) { ?>
                                        ...
                                        <?php if($jenis_surat == 1) { ?>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                                    ...
                                                    <textarea name="isi_surat[]" rows="5" required aria-required="true" class="form-control required" placeholder="Adukan permasaalahan dan kesan"><?php echo($myJSON[0]['isi_surat']); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                                    ...
                                                    <textarea name="isi_surat[]" rows="5" required aria-required="true" class="form-control required" placeholder="Nyatakan tindakkan yang telah diambil"><?php echo($myJSON[1]['isi_surat']); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                                    ...
                                                    <textarea name="isi_surat[]" rows="5" required aria-required="true" class="form-control required" placeholder="Nyatakan cadangan tindakan yang diinginkan bagi menyelesaikan permasalahan"><?php echo($myJSON[2]['isi_surat']); ?></textarea>
                                                </div>
                                            </div>
                                        <?php } ?>
                                        <?php if($jenis_surat == 3) { ?>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                                    <input type="hidden" name="id_isi[]" value="2">
                                                    <textarea name="isi_surat[]" rows="5" required aria-required="true" class="form-control required" placeholder="Nyatakan perkara yang ingin diberitahu"><?php echo($myJSON[0]['isi_surat']); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                                    <input type="hidden" name="id_isi[]" value="3">
                                                    <textarea name="isi_surat[]" rows="5" class="form-control" placeholder="Nyatakan perkara yang ingin diberitahu atau lain-lain makluman (tambahan)"><?php echo($myJSON[1]['isi_surat']); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="hidden" name="id_isi[]" value="4"><input placeholder="Masukkan nama" class="form-control" type="text" name="isi_surat[]" value="<?php echo($myJSON[3]['isi_surat']); ?>">
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <input type="hidden" name="id_isi[]" value="5"><input placeholder="Masukkan nombor telefon yang boleh dihubungi" class="form-control"  type="text" name="isi_surat[]" value="<?php echo($myJSON[4]['isi_surat']); ?>">
                                                </div>
                                            </div>
                                        <?php } ?>
                                        <?php if($jenis_surat == 4) { ?>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                                    <input type="hidden" name="id_isi[]" value="2">
                                                    <textarea name="isi_surat[]" rows="5" required aria-required="true" class="form-control required" placeholder="Nama Ahli Kariah / No IC Ahli Kariah atau Maklumat Yang Diberikan atau Perkara yang berkaitan"><?php echo($myJSON[0]['isi_surat']); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                                    ...
                                                    <input type="hidden" name="id_isi[]" value="3">
                                                    <textarea name="isi_surat[]" rows="5" required aria-required="true" class="form-control required" placeholder="Sila masukkan maklumat berkaitan tujuan pengesahan"><?php echo($myJSON[1]['isi_surat']); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                                    <label>3.0 Dengan pengesahan ini pihak saya selaku wakil beserta seluruh ahli kariah masjid tidak menangung sebarang libiliti daripada pengesahan ini.</label>
                                                </div>
                                            </div>
                                        <?php } ?>
                                        <?php if($jenis_surat == 5) { ?>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                                    <input type="hidden" name="id_isi[]" value="2">
                                                    <input class="form-control" type="text" name="isi_surat[]" placeholder="Perkara Yang Ingin di mohon" value="<?php echo($myJSON[0]['isi_surat']); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                                    <input type="hidden" name="id_isi[]" value="3">
                                                    <textarea name="isi_surat[]" rows="5" class="form-control" placeholder="Tujuan Permohonan"><?php echo($myJSON[1]['isi_surat']); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                                    ...
                                                    <input type="hidden" name="id_isi[]" value="4">
                                                    <textarea name="isi_surat[]" rows="10" class="form-control" placeholder="Masukkan perincian mengenai permohonan yang dibuat"><?php echo($myJSON[2]['isi_surat']); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                                    <label>3.0 Sebagai wakil, saya bagi pihak masjid ingin mengucapkan ribuan terima kasih di atas segala pertimbangan dan sebarang kerjasama yang di berikan.</label>
                                                </div>
                                            </div>
                                        <?php } ?>
                                        <?php if($jenis_surat == 6) { ?>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                                    <input type="hidden" name="id_isi[]" value="2">
                                                    <input class="form-control" type="text" name="isi_surat[]" placeholder="Nyatakan cadangan / nama individu" value="<?php echo($myJSON[0]['isi_surat']); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                                    <input type="hidden" name="id_isi[]" value="3">
                                                    <textarea name="isi_surat[]" rows="5" class="form-control" placeholder="Nyatakan Tujuan Cadangan / Tujuan hasrat Individu"><?php echo($myJSON[1]['isi_surat']); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                                    <label>2.0 Sebagai pengerusi saya berpendapat bahawa ,</label>
                                                    <input type="hidden" name="id_isi[]" value="4">
                                                    <textarea name="isi_surat[]" rows="5" class="form-control" placeholder="Nyatakan pendapat, mengapa menyokong"><?php echo($myJSON[2]['isi_surat']); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12 col-md-12">
                                        ...
                                        <?php if($jenis_surat == 2) { ?>
                                            ...
                                            <div id="borang_dinamik">
                                                ...
                                                <div id="row<?php echo($i); ?>" class="form-group row">
                                                    <div class="col-12 col-md-2">
                                                        <input class="form-control" type="time" name="id_isi[]" value="<?php echo($myJSON[$i]['id_isi']); ?>">
                                                    </div>
                                                    <div class="col-12 col-md-8">
                                                        <input name="isi_surat[]" type="text" class="form-control" placeholder="" value="<?php echo($myJSON[$i]['isi_surat']); ?>">
                                                    </div>
                                                    <div class="col-12 col-md-2">
                                ...
                                <div class="form-group row">
                                    <div class="col-12 col-md-6 text-center">
                                        ...
                                        <input name="id_surat" id="id_surat" value="<?php echo $_GET['id_surat']; ?>" type="hidden">
                                        <button type="submit" class="btn-primary validate btn btn-info btn-block margin-top-10">Kemaskini</button>
                                    </div>
                                </div>
                            <?php } ?>
                        </form>
