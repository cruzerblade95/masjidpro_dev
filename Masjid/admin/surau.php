                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
						  ...
						  $sql_search="SELECT id,nama_pengurus,no_tel,bil_anggota,nama_surau FROM sej6x_data_surau WHERE id_masjid='$id_masjid'"; 
                       ...
                       <form name="delete" method="POST" action="admin/del_surau.php">
					...
					<div class="col-lg-12">
						<div class="panel panel-info">
							<div class="panel-body">
								<form method="post" id="insert_form" action="admin/add_surau.php">
									<div class="row">
										<div class="col-lg-12">
...
<script>
    jQuery(document).ready(function () {
        meja_akaun('#meja_akaun2', 'Senarai Surau', [ 0, 1, 2, 3, 4 ]);
    });
</script>
