...
if(!empty($_POST))
{
	...
	$nama_balai=mysqli_real_escape_string($bd2, $_POST['nama_balai']);
	...
	$sql1 ="INSERT INTO sej6x_data_balai(id_masjid, nama_pengurus, no_tel,nama_balai,bil_anggota, alamat, negeri,daerah,poskod,last_added)
			   		VALUES($id_masjid,'$nama_pengurus','$no_tel','$nama_balai',$bil_anggota,'$alamat','$negeri',
			'$daerah',$poskod,NOW())";

$test=mysqli_query($bd2, $sql1);
	if($test)
	{
		    header("location: ../utama.php?view=admin&action=balai"); 
	}
	else
	{
