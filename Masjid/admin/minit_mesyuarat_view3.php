...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
   ...
   <script type="text/javascript" src="../../jspdf/libs/deflate.js"></script>
   <script type="text/javascript" src="../../jspdf/libs/html2pdf.js"></script>
   <script type="text/javascript" src="../../jspdf/plugins/addimage.js"></script>
   <script type="text/javascript" src="../../jspdf/plugins/autoprint.js"></script>
   ...
   <script type="text/javascript" src="../../jspdf/plugins/svg.js"></script>
   ...
   <div id="report" class="container">
    <?php while($row_list_mesyuarat = mysqli_fetch_assoc($list_mesyuarat)) { ?>
       <div class="row">
		  <div class="col-lg-3" align="left"><?php echo($row_list_mesyuarat['no_rujukan']); ?></div>
          <div class="col-lg-6" align="center" style="font-weight:bold">MINIT<br /><?php echo($row_list_mesyuarat['tajuk']); ?></div>
          <div class="col-lg-3" align="right"><?php fungsi_tarikh($row_list_mesyuarat['tarikh'], 2, 1); ?></div>
       </div>
       <p></p>
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
       <div class="panel-heading">Tarikh, Masa & Tempat</div>
       <div class="panel-body">
       <div class="row">
       	  <div class="col-lg-3">&nbsp;</div>
		  <div class="col-lg-3">Tarikh:</div>
          <div class="col-lg-3"><?php fungsi_tarikh($row_list_mesyuarat['tarikh'], 2, 1); ?></div>
          <div class="col-lg-3">&nbsp;</div>
       </div>
       <div class="row">
       	  <div class="col-lg-3">&nbsp;</div>
		  <div class="col-lg-3">Masa:</div>
          <div class="col-lg-3"><?php fungsi_tarikh($row_list_mesyuarat['masa'], 5, 1); ?></div>
          <div class="col-lg-3">&nbsp;</div>
       </div>
       <div class="row">
       	  <div class="col-lg-3">&nbsp;</div>
		  <div class="col-lg-3">Masa Tamat:</div>
          <div class="col-lg-3"><?php fungsi_tarikh($row_list_mesyuarat['masa_tamat'], 5, 1); ?></div>
          <div class="col-lg-3">&nbsp;</div>
       </div>
       <div class="row">
       	  <div class="col-lg-3">&nbsp;</div>
		  <div class="col-lg-3">Tempat:</div>
          <div class="col-lg-5"><?php echo($row_list_mesyuarat['tempat']); ?></div>
...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
       <div class="panel-heading">Kehadiran AJK</div>
       <div class="panel-body">
       ...
       <div class="row">
          ...
          <div class="col-lg-6"><?php echo($row_list_hadir['nama']); ?></div>
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
       <div class="panel-heading">Turut Hadir</div>
       <div class="panel-body">
       <div class="row" style="font-weight:bold">
       	  <div class="col-lg-1" align="center">Bil</div>
          <div class="col-lg-6">Nama</div>
       ...
       <div class="row">
       	  <div class="col-lg-1" align="center"><?php echo($i); ?></div>
          <div class="col-lg-6"><?php echo($row_list_hadir2['nama']); ?></div>
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
       <div class="panel-heading">Urusetia</div>
       <div class="panel-body">
       <div class="row" style="font-weight:bold">
       	  <div class="col-lg-1" align="center">Bil</div>
          <div class="col-lg-6">Nama</div>
       ...
       <div class="row">
       	  <div class="col-lg-1" align="center"><?php echo($i); ?></div>
          <div class="col-lg-6"><?php echo($row_list_hadir3['nama']); ?></div>
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
       <div class="panel-heading">Agenda Mesyuarat</div>
       <div class="panel-body">
       <div class="row" style="font-weight:bold">
       	  <div class="col-lg-1" align="center">Bil</div>
          <div class="col-lg-5">Perkara / Isu</div>
      ...
      <?php $i = 1; while($row_list_perkara = mysqli_fetch_assoc($list_perkara)) { ?>
       <div class="row">
       	  <div class="col-lg-1" align="center"><?php echo($i); ?></div>
          <div class="col-lg-5"><?php echo($row_list_perkara['perkara_isu']); ?></div>
...
doc.save('<?php echo($row_list_mesyuarat['tajuk']); ?>.pdf');
	</script>
    <?php } ?>
    </html>