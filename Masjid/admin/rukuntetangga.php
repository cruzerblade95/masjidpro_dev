                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            Senarai Rukun Tetangga &nbsp;&nbsp;
                            <button class="btn btn-info" type="button" data-toggle="modal" data-target="#myModal">Tambah Rukun Tetangga </button> &nbsp;&nbsp;
                        ...
                        <div class="card-body">
						  ...
						  $sql_search="SELECT id,nama_pengurus,no_tel,bil_anggota,nama_rukuntetangga FROM sej6x_data_rukuntetangga WHERE id_masjid='$id_masjid'"; 
							...
							<table id="meja_akaun2" width="100%" data-order="[]" class="table table-bordered table-hover display nowrap margin-top-10 w-p100 table-striped">
                                <thead>
                                  <tr>
                                    ...
                                    <th><div align="center">Nama Rukun Tetangga</div></th>
                              ...
                              <?php while($row = mysql_fetch_assoc($result)){ ?>
                                    ...
                                    <td><?php echo $row['nama_rukuntetangga']; ?></td>
                                    ...
                                    <td><div align="center">
                                      <a href="utama.php?view=admin&action=semak_rukuntetangga&id=<?php echo $row['id'];?>"><button type="btn btn-info" class="btn btn-warning btn-circle" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></button>
                                      </a>
                       <form name="delete" method="POST" action="admin/del_rukuntetangga.php">
                       ...
                       onclick="return confirm('Padam rekod?')"><i class="fa fa-times"></i></button></form></div>
                                      </td>
                                  </tr>
                                   <?php 
    ...
    <div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">DAFTAR RUKUN TETANGGA BARU</h4>
					...
					<div class="col-lg-12">
						<div class="panel panel-info">
							<div class="panel-body">
								<form method="post" id="insert_form" action="admin/add_rukuntetangga.php">
									<div class="row">
										<div class="col-lg-12">
											<h4 align="center"><u>Maklumat Rukun Tetangga</u></h4>
										</div>
									</div>
									<hr>
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												...
												<input class="form-control" name="nama_rukuntetangga" id="nama_rukuntetangga" required />
											</div>
											<div class="form-group">
										...
										<div class="col-lg-6">
											<div class="form-group">
												<label>Alamat Rukun Tetangga</label>
...
<script>
    jQuery(document).ready(function () {
        meja_akaun('#meja_akaun2', 'Senarai Rukun Tetangga', [ 0, 1, 2, 3, 4 ]);
    });
</script>
