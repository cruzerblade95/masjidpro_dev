                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input class="form-control" type="date" name="tarikh_kerosakan" style="width:237px" value="<?php echo $row['tarikh_lapor'];?>" disabled>
                                    &nbsp;
                                    <input class="form-control" type="time" name="masa_kerosakan" style="width:237px" value="<?php echo $row['masa_lapor'];?>" disabled>
                                </div>
                                <!--KOD PERALATAN-->
                                <div class="form-group">
                                    <label>Kod Peralatan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nama Peralatan</label>
                                    <br>
                                    <select class="form-control" name="id_peralatan" id="id_peralatan" style="width:237px" disabled>
                                    ...
                                    &nbsp;
                                    <select class="form-control" name="nama_peralatan" id="nama_peralatan" style="width:237px" disabled>
                                        <option value="">Sila Pilih Peralatan</option>
                                        <?php
                                        $sql = "SELECT id_inventori, kod_peralatan, nama_peralatan, jenis_peralatan FROM sej6x_data_inventori WHERE id_masjid = $id_masjid";
                                        $list_kod = mysqli_query($bd2, $sql) or die(mysqli_error($bd2));
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <select class="form-control" name="kat_peralatan" id="kat_peralatan" style="width:237px" disabled>
                                        <option value="">Sila Pilih Peralatan</option>
                                        <?php
                                    ...
                                    &nbsp;
                                    <select class="form-control" name="kat_penyelenggara" id="kat_penyelenggara" style="width:237px" disabled>
                                ...
                                <!--Nama Penyelenggara-->
                                <div class="form-group">
                                    <label>Nama Penyelenggara&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No.Telefon Penyelenggara</label>
                                    <br>
                                    <select class="form-control" name="id_penyelenggara" id="id_penyelenggara" style="width:237px" disabled>
                                        <option value="">Sila Pilih</option>
                                        <?php
                                ...
                                <div class="form-group">
                                    <label>Status </label>
                                    <select class="form-control" name="id_statuskerosakan" id="id_statuskerosakan" disabled>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input class="form-control" type="date" name="tarikh_kerosakan" style="width:237px" value="<?php echo $row['tarikh_kerosakan'];?>" disabled>
                                    &nbsp;
                                    <input class="form-control" type="time" name="masa_kerosakan" style="width:237px" value="<?php echo $row['masa_kerosakan'];?>" disabled>
                                </div>
                                <!--LOKASI PERALATAN-->
                                <div class="form-group">
                                    <label>Lokasi Peralatan</label>
                                    <input class="form-control" name="lokasi_kerosakan" id="lokasi_kerosakan" oninput="this.value = this.value.toUpperCase()" value="<?php echo $row['lokasi_kerosakan'];?>" disabled>
                                </div>
                                <!--KUANTITI & UNIT KUANTITI-->
                                <div class="form-group">
                                    <label>Kuantiti & Unit Kuantiti</label>
                                    <br>
                                    <input type="text" class="form-control" name="kuantiti" id="kuantiti" placeholder="Kuantiti" style="width:237px" value="<?php echo $row['kuantiti']; ?>" disabled>
                                    &nbsp;
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="id_pengesah" id="id_pengesah" disabled>
                                ...
                                <div class="form-group">
                                    <label>Catatan</label>
                                    <textarea class="form-control" rows="2" name="catatan" disabled><?php echo $row['catatan'];?></textarea>
                                </div>
                            </div>
