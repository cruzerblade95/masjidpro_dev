    ...
    <div class="col-sm-8">
        <div class="page-header float-left">
            <div class="page-title">
                <h3>Senarai Jawatankuasa Pengurusan</h3>
            </div>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    <li class="active">Senarai Jawatankuasa Pengurusan Masjid</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="content mt-3">
    ...
    if(isset($_POST['search']))
    {
        ...
        $sql_search = "SELECT rekod_organisasi.id, rekod_organisasi.id_rekod , rekod_organisasi.nama_penuh, rekod_organisasi.no_pengenalan, rekod_organisasi.no_telefon, rekod_organisasi.emel, rekod_organisasi.tarikh_lantikan,
                       ...
                       WHERE rekod_organisasi.kategori_jawatankuasa = 'pengurusan' AND rekod_organisasi.id_masjid = $id_masjid AND rekod_organisasi.tarikh_lantikan BETWEEN STR_TO_DATE('$tahun1', '%Y-%m-%d') AND STR_TO_DATE('$tahun2', '%Y-%m-%d') ORDER BY rekod_organisasi.tarikh_lantikan ASC;";
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <form method="post" id="ajkmasjid" action="" enctype="multipart/form-data">
                                <table id="senarai_jawatankuasa_pengurusan" width="100%" data-order="[]" class="table table-striped table-bordered table-hover">
                                    <thead>
                                    <tr>
...
//                                            ?>
                                        <tr>
                                            ...
                                            <td><div align="center">
                                                    <div class="row">
                                                        <a href="utama.php?view=admin&action=view_jawatankuasa&id_organisasi=<?php echo $row['id']; ?>&nokuasa=3&sideMenu=organisasi">
                                                            <button type="button" class="btn btn-info btn-circle" data-toggle="tooltip" data-placement="right" title="Papar">
                                                                <i class="fa fa-search"></i>
                                                            </button>
                                                        </a>
                                                        <a href="utama.php?view=admin&action=edit_jawatankuasa&id_organisasi=<?php echo $row['id']; ?>&nokuasa=3&sideMenu=organisasi">
                                                        ...
                                                        <form name="delete" method="POST" action="admin/del_jawatankuasa.php">
                                                            ...
                                                            <input type="hidden" name="nokuasa" id="nokuasa" value="3">
...
<script>
    jQuery(document).ready(function () {
        meja_akaun('#senarai_jawatankuasa_pengurusan', 'Senarai Jawatankuasa Pengurusan Masjid', [ 0, 1, 2, 3, 4, 5 ]);
    });
</script>
