<?php 
	...
	$sql_search="SELECT 
	id,id_masjid, nama_pengurus, no_tel,nama_rumahibadat,bil_anggota, alamat, negeri, 
	daerah,poskod
	FROM sej6x_data_rumahibadat
	WHERE id='".$idd."' ";
		...
		<div class="page-header float-right">
			<div class="page-title">
				<ol class="breadcrumb text-right">
					...
					<li><a href="utama.php?view=admin&action=rumahibadat">Rumah Ibadat</a></li>
					<li class="active">Semak Rumah Ibadat</li>
				</ol>
			</div>
		</div>
	</div>
...
<div class="content mt-3">
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">Maklumat Rumah Ibadat</div> 
				<div class="card-body">
					<form method="post" action="admin/update_rumahibadat.php" name="rumahibadat">
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<input class="form-control" name="nama_rumahibadat" id="nama_rumahibadat" value="<?php echo $row['nama_rumahibadat'];?>" required />
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
