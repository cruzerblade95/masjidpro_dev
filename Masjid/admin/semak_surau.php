<?php 
	...
	$sql_search="SELECT 
	id,id_masjid, nama_pengurus, no_tel,nama_surau,bil_anggota, alamat, negeri, 
	daerah,poskod
		...
		<div class="page-header float-right">
			<div class="page-title">
				<ol class="breadcrumb text-right">
					...
					<li><a href="utama.php?view=admin&action=surau">Surau</a></li>
					<li class="active">Semak Surau</li>
				</ol>
			</div>
		</div>
	</div>
...
<div class="content mt-3">
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">Maklumat Surau</div> 
				<div class="card-body">
					<form method="post" action="admin/update_surau.php" name="surau">
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<input class="form-control" name="nama_surau" id="nama_surau" value="<?php echo $row['nama_surau'];?>" required />
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
