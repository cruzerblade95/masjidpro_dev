    ...
    <div class="col-sm-4">
        <div class="page-header float-left">
            <div class="page-title">
                <h1>Senarai Kehadiran Pegawai Masjid</h1>
            </div>
        </div>
    </div>
    <div class="col-sm-8">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        $sql_search="SELECT a.id_datapegawai 'id', a.id_fingerprint 'fingerprint' ,a.jawatan 'jawatan', b.nama_penuh 'nama' FROM data_pegawai_masjid a, sej6x_data_peribadi b WHERE a.id_masjid='$id_masjid' AND a.id_pegawai=b.id_data 
                                     ...
                                     UNION SELECT f.id 'id', f.id_fingerprint 'fingerprint', f.jawatan 'jawatan', f.nama_penuh 'nama' FROM rekod_organisasi f WHERE f.kategori_jawatankuasa = 'pegawai'
                                     UNION SELECT e.id_datapegawai 'id', e.id_fingerprint 'fingerprint', e.jawatan 'jawatan', e.nama_penuh 'nama' FROM data_pegawai_masjid e 
                                     WHERE e.id_masjid='$id_masjid' AND e.id_pegawai IS NULL AND e.id_pegawai2 IS NULL
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            while($row = mysqli_fetch_assoc($result))
                            {
                                ...
                                <tr>
                                    ...
                                    <td><div align="center"><?php echo ucfirst($row['jawatan']); ?></div></td>
                                    <td>
                                        <div align="center">
                                            <a href="utama.php?view=admin&action=organisasi_laporan_senaraiPEGAWAI_individu&id_pegawai=<?php echo $row['id'];?>&sideMenu=organisasi">
