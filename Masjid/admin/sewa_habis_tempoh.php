    ...
    <div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">SEWA HABIS TEMPOH</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
            <!-- /.row -->
            <?php
              $sql_search="SELECT * FROM maklumat_sewaan"; 
  				            ...
  				            <th><div align="center">Tindakan</div></th>
                                   ...
                                   <?php while($row = mysql_fetch_assoc($result)){ ?>
                                      <tr class="odd gradeX">
                                          ...
                                          <td><div align="center">
                                          <a href="utama.php?view=admin&action=susut_nilai&id_inventori=<?php echo $row['id_inventori'];?>&tarikh_belian=<?php echo $row['tahun'];?>"><button type="button" class="btn btn-info btn-circle" data-toggle="tooltip" data-placement="right" title="Lihat">
