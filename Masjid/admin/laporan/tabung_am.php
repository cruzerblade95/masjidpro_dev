            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Tabung Am</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Tabung Am</h4>
                                        </div>
                                        <div class="modal-body">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="panel panel-info">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            <h4 align="center"><u>Maklumat Tabung Am</u></h4>
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>Tunai/Bank In</label>
                                                                        <input class="form-control" placeholder="Contoh: 880528-35-5036" >  
                                                                    </div>
                                                            ...
                                                            <div class="col-lg-4">  
                                                                    ...
                                                                    <div class="form-group">
                                                                     ...
                                                                     <div class="form-group">
                                                                        <label>Amaun (RM)</label>
                                                                        <input class="form-control" placeholder="Contoh: 014-3159891" >
                                                                    </div>  
                                                            </div>
                                                            <!-- /.col-lg-4 (nested) -->
                                                    </div>
