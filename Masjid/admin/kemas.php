<?php 
	...
	$sql_search="SELECT id,nama_pengurus,no_tel,bil_pelajar,nama_kemas FROM sej6x_data_kemas WHERE id_masjid='$id_masjid'"; 
						...
						<table id="meja_akaun2" width="100%" data-order="[]" class="table table-bordered table-hover display nowrap margin-top-10 w-p100 table-striped">
							...
							?>
								<tr>
									...
									<td>
										<div align="center">
											<a href="utama.php?view=admin&action=semak_kemas&id=<?php echo $row['id'];?>">
					...
					<div class="col-lg-12">
						<div class="panel panel-info">
							<div class="panel-body">
								<form method="post" id="insert_form" action="admin/add_kemas.php">
									<div class="row">
										<div class="col-lg-12">
...
<script>
    jQuery(document).ready(function () {
        meja_akaun('#meja_akaun2', 'Senarai KEMAS', [ 0, 1, 2, 3, 4 ]);
    });
</script>
