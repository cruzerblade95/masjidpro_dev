		...
		<div class="page-header float-right">
			<div class="page-title">
				<ol class="breadcrumb text-right">
					...
					<li class="active">Klinik/Hospital</li>
				</ol>
			</div>
		</div>
	</div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            Senarai Klinik &nbsp;&nbsp;
                            <button class="btn btn-info" type="button" data-toggle="modal" data-target="#myModal">Tambah Klinik </button>&nbsp;       <button class="btn btn-info" onclick="history.go(-1);">Kembali </button>           </div>
                        <!-- /.panel-heading -->
                        <div class="card-body">
						  ...
						  $sql_search="SELECT id,nama_pengurus,no_tel,bil_anggota,nama_klinik FROM sej6x_data_klinik WHERE id_masjid='$id_masjid'"; 
						  ...
						  ?>              
                              <table id="meja_akaun2" width="100%" data-order="[]" class="table table-bordered table-hover display nowrap margin-top-10 w-p100 table-striped">
                                <thead>
                                  <tr>
                                    ...
                                    <th><div align="center">Nama Klinik</div></th>
                              ...
                              <?php while($row = mysql_fetch_assoc($result)){ ?>
                                    ...
                                    <td><div align="center"><?php echo $row['nama_klinik']; ?></div></td>
                                   ...
                                   <td>
                                      <div align="center">
                                      <a href="utama.php?view=admin&action=semak_klinik&id=<?php echo $row['id'];?>"><button type="btn btn-info" class="btn btn-warning btn-circle" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></button>
                                      </a>
                       <form name="delete" method="POST" action="admin/del_klinik.php">
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">DAFTAR KLINIK BARU</h4>
					...
					<div class="col-lg-12">
						<div class="panel panel-info">
							<div class="panel-body">
								<form method="post" id="insert_form" action="admin/add_klinik.php">
									<div class="row">
										<div class="col-lg-12">
											<h4 align="center"><u>Maklumat Klinik</u></h4>
										</div>
									</div>
									<hr>
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
											  ...
											  <input class="form-control" name="nama_klinik" id="nama_klinik" required />
											</div>
											<div class="form-group">
...
<script>
    jQuery(document).ready(function () {
        meja_akaun('#meja_akaun2', 'Senarai Klinik', [ 0, 1, 2, 3, 4 ]);
    });
</script>
