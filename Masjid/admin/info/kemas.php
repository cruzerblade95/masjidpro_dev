                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Senarai KEMAS
                            <button class="btn btn-info" type="button" data-toggle="modal" data-target="#myModal">Tambah KEMAS </button>                   </div>
                        <!-- /.panel-heading -->
						  ...
						  ?>              
                              ...
                              <?php while($row = mysql_fetch_assoc($result)){ ?>
                                    ...
                                    <div align="center">
                                      ...
                                      <a href="utama.php?view=semak_kemas&id=<?php echo $row['id'];?>"><button type="btn btn-info" class="btn btn-warning btn-circle" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></button>
                                      
                       <form name="delete" method="POST" action="info/del_kemas.php">
