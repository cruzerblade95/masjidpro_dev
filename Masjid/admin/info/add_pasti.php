...
if(!empty($_POST))
{
	...
	$sql1 ="INSERT INTO sej6x_data_pasti(id,id_masjid, nama_pengurus, no_tel,nama_pasti,bil_pelajar, alamat, negeri,daerah,poskod,last_added)
...
$test=mysql_query($sql1, $bd);
	if($test)
	{
		    header("location: ../utama.php?view=pasti"); 
	}
	else
	{
		echo mysql_error();
