                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Senarai Surau
                            <button class="btn btn-info" type="button" data-toggle="modal" data-target="#myModal">Tambah Surau </button>                   </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
						  ...
						  ?>              
                              ...
                              <?php while($row = mysql_fetch_assoc($result)){ ?>
                                    ...
                                    <td>
                                      <div align="center">
                                      <a href="utama.php?view=semak_surau&id=<?php echo $row['id'];?>"><button type="btn btn-info" class="btn btn-warning btn-circle" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></button>
