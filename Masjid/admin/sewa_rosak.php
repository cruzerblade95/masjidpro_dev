    ...
    <div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">SEWA ROSAK</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
            <!-- /.row -->
            <?php
              $sql_search="SELECT * FROM maklumat_sewaan where sewa_keadaan='2'"; 
  				            ...
  				            <th><div align="center">Tindakan</div></th>
                                   ...
                                   <?php while($row = mysql_fetch_assoc($result)){ ?>
                                      <tr class="odd gradeX">
                                          ...
                                          <td><div align="center">
                                          <a href="utama.php?view=admin&action=detail_sewa_rosak&no_barang=<?php echo $row['sewa_rujukan'];?>"><button type="button" class="btn btn-info btn-circle" data-toggle="tooltip" data-placement="right" title="Lihat">
