   <div class="row">
   	<div class="col-lg-12">
   		<h2 align="center" class="page-header">WARGA EMAS</h2>
   	</div>
   	<!-- /.col-lg-12 -->
   </div>
   <?php
   				...
   				<div class="col-lg-12">
   					<div class="panel panel-default">
   						<div class="panel-heading">
   							Maklumat Warga Emas</div>

   						<div class="panel-body">

   							<form method="post" id="warga emas" action="admin/sql_update_wargaemas.php">
   								...
   								<div class="row">
   									...
   									<div class="col-lg-4 border">
   										...
   										<div class="form-group">
   											...
   											<input type="text" name="nama_penuh" class="form-control" value="<?php echo $row['nama_penuh']; ?>" readonly>
   										</div>

   										<div class="form-group">
   											<label>No. K/P</label>
   											<input type="text" name="no_ic" class="form-control" value="<?php echo $row['no_ic']; ?>" readonly>
   										</div>
   										...
   										<div class="form-group">
   											<label>Umur</label>
   											<input type="text" name="umur" class="form-control" value="<?php echo $row['umur']; ?>" readonly>
   										</div>

   										<div class="form-group">
   											<label>Tarikh Lahir</label>
   											<input type="date" name="tarikh_lahir" class="form-control" value="<?php echo $row['tarikh_lahir']; ?>" readonly>
   										</div>

   										<div class="form-group">
   											<label>Jantina</label>
   											<select class="form-control" name="jantina" id="jantina" readonly>
   									...
   									<div class="col-lg-4 border">
   										...
   										<div class="form-group">
   											...
   											<select class="form-control" name="warganegara" id="warganegara" readonly>
   												<option>Sila Pilih</option>
   												<option value="1" <?php
   										...
   										<div class="form-group">
   											...
   											<select class="form-control" name="status_perkahwinan" id="status_perkahwinan" readonly>
   										...
   										<div class="form-group">
   											...
   											<select class="form-control" name="zon_qariah" id="zon_qariah" readonly>
   									...
   									<!-- /.col-lg-4 (nested) -->
   										<div class="col-lg-4 border">
   											<div class="form-group">
   												...
   												<input type="text" name="alamat_terkini" class="form-control" value="<?php echo $row['alamat_terkini']; ?>" readonly>
   											</div>

   											<div class="form-group">
   												<label>Negeri</label>
   												<select class="form-control" name="id_negeri" id="id_negeri" readonly>
   													<option value="default">Sila Pilih</option>
   											...
   											<div class="form-group">
   												<label>Poskod</label>
   												<input type="text" name="poskod" class="form-control" value="<?php echo $row['poskod']; ?>" readonly>
   											</div>
