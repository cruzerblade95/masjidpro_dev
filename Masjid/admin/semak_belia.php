<?php 
	...
	$sql_search="SELECT 
	id,id_masjid, nama_pengurus, no_tel,nama_belia,bil_anggota, alamat, negeri, 
	daerah,poskod
	FROM sej6x_data_beliaa
	WHERE id='".$idd."' ";
		...
		<div class="page-header float-right">
			<div class="page-title">
				<ol class="breadcrumb text-right">
					...
					<li><a href="utama.php?view=admin&action=belia">Belia</a></li>
					<li class="active">Semak Belia</li>
				</ol>
			</div>
		</div>
	</div>
...
<div class="content mt-3">
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">Maklumat Belia</div> 
					<div class="card-body">
						<form method="post" action="admin/update_belia.php" name="belia">
						<div class="row">
							<div class="col-lg-6">
								...
								<div class="form-group">
									...
									<input class="form-control" name="nama_belia" id="nama_belia" value="<?php echo $row['nama_belia'];?>" required />
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group">
