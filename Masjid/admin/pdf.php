...
@media print {
  .pecah {page-break-before: always;}
}  
    </style>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js" integrity="sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1" crossorigin="anonymous"></script>
   ...
   <div id="html" style='position: absolute; left: 70; right: 70; top: 30; bottom: 30; overflow: auto; width: 600px; font-family:Arial, Helvetica, sans-serif; font-size:10pt; height: 100%'>
   <p>&nbsp;</p>
   <div class="row">
		  <div class="col" align="center"><?php echo($row_list_mesyuarat['no_rujukan']); ?></div>
          <div class="col" align="center">MINIT</div>
          <div class="col" align="right"><?php echo ($row_list_mesyuarat['tarikh']); ?></div>
       </div>
       <div class="row">
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
       ...
       <div class="row">
          ...
          <div class="col-lg-6"><?php echo $row_list_mesyuarat['tarikh']; ?></div>
          <div class="col-lg-1">&nbsp;</div>
       </div>
       <div class="row">
       	  <div class="col-lg-2">&nbsp;</div>
		  <div class="col-lg-3">Masa:</div>
          <div class="col-lg-6"><?php echo $row_list_mesyuarat['masa']; ?></div>
          <div class="col-lg-1">&nbsp;</div>
       </div>
       <div class="row">
       	  <div class="col-lg-2">&nbsp;</div>
		  <div class="col-lg-3">Masa Tamat:</div>
          <div class="col-lg-6"><?php echo $row_list_mesyuarat['masa_tamat']; ?></div>
          <div class="col-lg-1">&nbsp;</div>
       </div>
       <div class="row">
       	  <div class="col-lg-2">&nbsp;</div>
...
<?php if(($jum_hadir2 > 0 && $jum_hadir3 < 1) || ($jum_hadir2 > 0 && $jum_hadir3 > 0)) { ?><div id="hadir_lain"><?php } ?>
     <p>&nbsp;</p>
     <div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
...
<?php if($jum_hadir2 > 0 && $jum_hadir3 < 1) { ?></div><?php } ?>
    <?php } ?>
    <?php if($totalRows_list_hadir3 = mysqli_num_rows($list_hadir3)) { ?>
    <?php if($jum_hadir2 < 1 && $jum_hadir3 > 0) { ?><div id="hadir_lain"><?php } ?>
     <p>&nbsp;</p>
...
<?php if(($jum_hadir2 < 1 && $jum_hadir3 > 0) || ($jum_hadir2 > 0 && $jum_hadir3 > 0)) { ?></div><?php } ?>
    <?php } ?>
    <div id="perkara">
    <p>&nbsp;</p>
     <div class="row">
