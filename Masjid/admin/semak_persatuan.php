<?php 
	...
	$sql_search="SELECT 
	id,id_masjid,nama_persatuan, nama_pengurus, no_tel,bil_anggota, alamat, negeri, 
	daerah,poskod
	FROM sej6x_data_persatuan
	WHERE id='".$idd."' ";
		...
		<div class="page-header float-right">
			<div class="page-title">
				<ol class="breadcrumb text-right">
					...
					<li><a href="utama.php?view=admin&action=persatuan">Persatuan</a></li>
					<li class="active">Semak Persatuan</li>
				</ol>
			</div>
		</div>
	</div>
...
<div class="content mt-3">
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">Maklumat Persatuan</div> 
				<div class="card-body">
					<form method="post" action="admin/update_persatuan.php" name="persatuan">
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<input class="form-control" name="nama_persatuan" id="nama_persatuan" value="<?php echo $row['nama_persatuan'];?>" required />
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
