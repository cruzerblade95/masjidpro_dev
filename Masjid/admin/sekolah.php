			...
			<div class="card">
				...
				<div class="card-body">
					...
					<?php 
						...
						$sql_search="SELECT id,nama_pengurus,no_tel,bil_pelajar,nama_sekolah FROM sej6x_data_sekolah WHERE id_masjid='$id_masjid'"; 
						...
						<table id="meja_akaun2" width="100%" data-order="[]" class="table table-bordered table-hover display nowrap margin-top-10 w-p100 table-striped">
							...
							?>
								<tr>
									...
									<td class="center">
										<div align="center">
											<a href="utama.php?view=admin&action=semak_sekolah&id=<?php echo $row['id'];?>">
					...
					<div class="col-lg-12">
						<div class="panel panel-info">
							<div class="panel-body">
								<form method="post" id="insert_form" action="admin/add_sekolah.php">
									<div class="row">
										<div class="col-lg-12">
...
<script>
    jQuery(document).ready(function () {
        meja_akaun('#meja_akaun2', 'Senarai Sekolah', [ 0, 1, 2, 3, 4 ]);
    });
</script>
