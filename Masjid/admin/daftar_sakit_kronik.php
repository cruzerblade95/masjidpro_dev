		...
		<div class="page-header float-right">
			<div class="page-title">
				<ol class="breadcrumb text-right">
					...
					<li class="active">Daftar Sakit Kronik</li>
				</ol>
			</div>
		</div>
	</div>
									...
									<tr>
										...
										<td>
											<div align="center">
												...
												$sql="SELECT * FROM sej6x_data_sakit WHERE id_data='$id_data'";
												...
												{
												?>
												<a href="utama.php?view=admin&action=butiran_sakit&id_data=<?php echo $row['id_data'];?>" class="btn btn-success">Daftar</a>
												<?php
												}
												else if($bil>0)
												{
												?>
												<a href="utama.php?view=admin&action=semak_sakit&id_data=<?php echo $data['id_data']; ?>" class="btn btn-success">Kemaskini</a>
												<?php
												}
												?>
											</div> 
									...
									<tr>
										...
										<td>
											<div align="center">
												...
												$sql1="SELECT * FROM sej6x_data_sakit WHERE id_anak='$ID'";
												...
												{												
												?>
												<a href="utama.php?view=admin&action=butiran_sakit&id=<?php echo $row1['ID']; ?>" class="btn btn-success">Daftar</a>
												<?php
												}
												else if($bil1>0)
												{
												?>
												<a href="utama.php?view=admin&action=semak_sakit&id=<?php echo $row1['ID']; ?>" class="btn btn-success">Kemaskini</a>
												<?php
												}
												?>
											</div> 
