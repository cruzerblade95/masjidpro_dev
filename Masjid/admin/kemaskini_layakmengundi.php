<div class="breadcrumbs">
	<div class="col-sm-4">
		<div class="page-header float-left">
			<div class="page-title">
				<h1>Kemaskini Maklumat Layak Mengundi</h1>
			</div>
		</div>
	</div>
	<div class="col-sm-8">
		<div class="page-header float-right">
			<div class="page-title">
				<ol class="breadcrumb text-right">
					...
					<li><a href="utama.php?view=admin&action=pendaftaran_layak_mengundi">Senarai Layak Undi</a></li>
					<li class="active">Kemaskini Layak Mengundi</li>
				</ol>
			</div>
		</div>
	</div>
   ...
   <div class="row">
                <div class="col-lg-12">
                    <h2 align="center" class="page-header">KEMASKINI LAYAK MENGUNDI</h2>
                </div>
                <!-- /.col-lg-12 -->
</div>
 <?php 
   ...
   <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Maklumat Layak Mengundi</div>

                        <div class="panel-body">
							     
                                       <form method="post" id="layak_mengundi" action="admin/update_layakmengundi.php">
