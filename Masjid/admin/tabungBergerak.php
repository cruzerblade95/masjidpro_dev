...
<div class="row">
                    <div class="col-lg-12">
                       ...
                       TABUNG BERGERAK <br>BULAN <?php echo $bulan ?> TAHUN <?php echo $tahun ?></h2>
...
<div class="panel-heading">Tabung Bergerak 
 <button onclick="myFunction()" class="btn btn-primary">Cetak</button> <!-- || <button class="btn btn-success" onClick="history.go(-1);">Kembali</button> -->
<script>
function myFunction() {
    window.print();
}
...
<thead>
				...
				$sql_search="SELECT 
				id_bukutunai,id_masjid,tarikh,jenis_duit,jenis_tabung,butiran,amount
				FROM buku_tunai 
