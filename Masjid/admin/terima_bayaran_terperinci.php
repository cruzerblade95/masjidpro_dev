                ...
                <!-- /.col-lg-12 -->
                  <?php 
						 ...
						 // $bil_tahun = $_GET['bil_tahun'];
						  ...
						  if($_GET['id_data'] != 0) 
							  $sql_search="SELECT b.id_data,b.nama_penuh,b.no_ic,a.tarikh_bayaran,a.jumlah,b.no_hp,c.nama_penuh as 'Ajk',a.id_bayaran FROM sej6x_data_terimabayaran a, sej6x_data_peribadi b,sej6x_data_ajkmasjid c WHERE a.id_bayaran='".$idd."' AND a.id_data=b.id_data AND a.id_ajk=c.id_ajk";
