    ...
    <div class="col-sm-8">
        <div class="page-header float-left">
            <div class="page-title">
                <h3>Senarai Jawatankuasa AJK</h3>
            </div>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    <li class="active">Senarai Jawatankuasa AJK Masjid</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="content mt-3">
    ...
    if(isset($_POST['search']))
    {
        ...
        $sql_search = "SELECT id, id_rekod , nama_penuh, no_pengenalan, no_telefon, emel, tarikh_lantikan, kategori_jawatankuasa, jawatan, ajk_biro      
                       FROM rekod_organisasi WHERE kategori_jawatankuasa = 'ajk' AND id_masjid = $id_masjid AND tarikh_lantikan BETWEEN STR_TO_DATE('$tahun1', '%Y-%m-%d') AND STR_TO_DATE('$tahun2', '%Y-%m-%d') ORDER BY tarikh_lantikan ASC;";
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                       Senarai Jawatankuasa AJK Masjid
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <form method="post" id="ajkmasjid" action="" enctype="multipart/form-data">
                                <table id="senarai_jawatankuasa_ajk" width="100%" data-order="[]" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
...
//                                            ?>
                                            <tr>
                                                ...
                                                <td><div align="center">
                                                        <div class="row">
                                                            <a href="utama.php?view=admin&action=view_jawatankuasa&id_organisasi=<?php echo $row['id']; ?>&nokuasa=1&sideMenu=organisasi">
                                                                <button type="button" class="btn btn-info btn-circle" data-toggle="tooltip" data-placement="right" title="Papar">
                                                                    <i class="fa fa-search"></i>
                                                                </button>
                                                            </a>
                                                            <a href="utama.php?view=admin&action=edit_jawatankuasa&id_organisasi=<?php echo $row['id']; ?>&nokuasa=1&sideMenu=organisasi">
                                                            ...
                                                            <form name="delete" method="POST" action="admin/del_jawatankuasa.php">
                                                                ...
                                                                <input type="hidden" name="nokuasa" id="nokuasa" value="1">
...
<script>
    jQuery(document).ready(function () {
        meja_akaun('#senarai_jawatankuasa_ajk', 'Senarai Jawatankuasa AJK Masjid', [ 0, 1, 2, 3, 4, 5 ]);
    });
</script>
