<?php
	...
	?>
	<form action="admin/edit_rekodbantuan.php" id="form_ic" name="form_ic" class="form-horizontal form-bordered" method="POST">
		<div class="form-body">
			<div class="form-group row">
				<label class="control-label text-right col-md-3">Nama Penuh</label>
				<div class="col-md-9">
					<input type="text" name="nama_penuh" class="form-control" value="<?php echo strtoupper($data_ic['nama_penuh']); ?>" readonly>
				</div>
			</div>
			<div class="form-group row">
            ...
            <?php if ($data_bantuan['id_data'] != NULL) { ?>
			<div class="form-group row">
	...
	else if($data_bantuan['id_data']==NULL)
	{
		...
		{
	?>
<form action="admin/edit_rekodbantuan.php" id="form_passport" name="form_passport" class="form-horizontal form-bordered" method="POST">
		<div class="form-body">
			<div class="form-group row">
				<label class="control-label text-right col-md-3">Nama Penuh</label>
				<div class="col-md-9">
			...
			<input type="hidden" name="id_bantuan" value="<?php echo $data_bantuan['id_bantuan_zakat']; ?>">
			<input type="hidden" name="id_masjid" value="<?php echo $id_masjid; ?>">
			<div class="form-group row">
				<div class="col-md-4 offset-4">
					<center>
