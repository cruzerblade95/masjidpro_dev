...
if (isset($_POST['simpan']) && $semak == 2) {
    ...
    $alamat_terkini = e($_POST['alamat_terkini']);
    ...
    if ($run > 0) {
        $kemaskini = "UPDATE sej6x_data_peribadi SET data_mualaf = '$data_mualaf', no_rujukan = '$no_rujukan', data_sakit = '$data_sakit', data_asnaf = '$data_asnaf', data_ibutunggal = '$data_ibutunggal', data_anakyatim = '$data_anakyatim', nama_penuh = '$nama_penuh', no_ic = '$no_ic', tarikh_lahir = '$tarikh_lahir', no_hp = '$no_hp', umur = '$umur', jantina = '$jantina', bangsa = $bangsa, warganegara = $warganegara, status_perkahwinan = $status_perkahwinan, pekerjaan = '$pekerjaan', tempoh_tinggal = '$tempoh_tinggal', zon_qariah = '$zon_qariah', alamat_terkini = '$alamat_terkini', id_negeri = $id_negeri, id_daerah = $id_daerah, poskod = '$poskod', solat_jumaat = $solat_jumaat, oku = $oku WHERE id_data = $id_data";
        ...
        if ($row > 0) {
            $kemaskini = "UPDATE approve_qariah SET data_mualaf = '$data_mualaf', no_rujukan = '$no_rujukan', data_sakit = '$data_sakit', data_asnaf = '$data_asnaf', data_ibutunggal = '$data_ibutunggal', data_anakyatim = '$data_anakyatim', nama_penuh = '$nama_penuh', no_ic = '$no_ic', tarikh_lahir = '$tarikh_lahir', no_tel = '$no_hp', umur = '$umur', jantina = $jantina, bangsa = $bangsa, warganegara = $warganegara, status_perkahwinan = $status_perkahwinan, pekerjaan = '$pekerjaan', tempoh_tinggal = '$tempoh_tinggal', zon_qariah = '$zon_qariah', no_rumah = '$alamat_terkini', negeri = $id_negeri, daerah = $id_daerah, poskod = '$poskod', solat_jumaat = $solat_jumaat, oku = $oku WHERE id = $id_data";
            mysqli_query($bd2, $kemaskini) or die(mysqli_error($bd2));
            ...
            $sql1 = "INSERT IGNORE INTO approve_qariah
				(data_mualaf, no_rujukan, data_sakit, data_anakyatim, data_ibutunggal, data_asnaf, id_masjid,nama_penuh,no_ic,tarikh_lahir,no_tel,umur,jantina,bangsa,warganegara,status_perkahwinan,pekerjaan,tempoh_tinggal,zon_qariah,no_rumah,negeri,daerah,poskod,solat_jumaat,oku)
				VALUES
				('$data_mualaf', '$no_rujukan', '$data_sakit', '$data_anakyatim', '$data_ibutunggal', '$data_asnaf', '$id_masjid','$nama_penuh','$no_ic','$tarikh_lahir','$no_hp','$umur','$jantina','$bangsa','$warganegara','$status_perkahwinan','$pekerjaan','$tempoh_tinggal','$zon_qariah','$alamat_terkini','$id_negeri','$id_daerah','$poskod', $solat_jumaat, $oku)
				";
    ...
    if($run == 0) $sql3 = "SELECT * FROM approve_qariah WHERE no_ic = '$no_ic'";
    if($run > 0) $sql3 = "SELECT * FROM sej6x_data_peribadi WHERE no_ic = '$no_ic'";
    $sqlquery3 = mysqli_query($bd2, $sql3) or die(mysqli_error($bd2));
    $data3 = mysqli_fetch_array($sqlquery3);
    if($run == 0) $ID = $data3['id'];
    if($run > 0) $ID = $data3['id_data'];
    ...
    if ($number > 0) {
        ...
        for ($i = 0; $i < $number; $i++) {
            ...
            if($_POST["nama_tanggungan"][$i] != NULL) {
                ...
                if ($run == 0) $kemas_sakit = 2;
                if ($run > 0) $kemas_sakit = 1;
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label style="color: red">*</label><b>Nama Penuh</b> <input
                                            class="form-control" name="nama_penuh" id="nama_penuh"
                                            required value="<?php echo($kemas['nama_penuh']); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label style="color: red">*</label><b>No. K/P</b> <input
                                            class="form-control" name="no_ic" id="no_ic"
                                            placeholder="Contoh: 880528355036" minlength="12"
                                            maxlength="12" required onChange="myFunction()" value="<?php echo($no_ic); ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input readonly class="form-control" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" name="tarikh_lahir_type" id="tarikh_lahir_type" placeholder="Contoh: 1992-05-30" required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        <label style="color: red">*</label><b>Warganegara</b> <select
                                            ...
                                            required>
                                            <option value="">Sila Pilih</option>
                                            <option value="1" <?php if($kemas['warganegara'] == 1) echo('selected'); ?>>Warganegara</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="tempoh_tinggal"
                                               id="tempoh_tinggal" required value="<?php echo($kemas['tempoh_tinggal']); ?>">
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label style="color: red">*</label><b>Alamat
                                            Terkini</b> <input class="form-control"
                                                               placeholder="Contoh: 1842-2 Kampung Selamat"
                                                               name="alamat_terkini" id="alamat_terkini" required value="<?php echo($alamat_terkini); ?>">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label style="color: red">*</label><b>Wajib Solat Jumaat</b> <select
                                            class="form-control form-group" name="solat_jumaat" id="solat_jumaat"
                                            required>
                                            <option value="">Sila Pilih</option>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label style="color: red">*</label><b>Mualaf</b> <select
                                            class="form-control form-group" name="data_mualaf" id="data_mualaf" required>
                                            <option value="">Sila Pilih</option>
                                ...
                                <div class="col-12 col-md-12">
                                    <script>data_sakit(0, '<?php echo($kemas['data_sakit']); ?>', 'id_penyakit[]', 'rawatan_terkini[]', 'add_sakit', 'borang_sakit', 'padam_sakit', 'baris_sakit', 'id_sakit_', 'id_sakit[]', 'id_sakit_padam[]', '', 'Padam Penyakit')</script>
                                    ...
                                    <div id="borang_sakit" class="col-12 col-md-12 form-group">
                                        <?php if($jum_sakit_p > 0) { $i = 1; do { ?>
                                            <script>data_sakit_ada('#add_sakit', 'id_penyakit[]', '<?php echo($sakit_p['id_penyakit']); ?>', 'rawatan_terkini[]', '<?php echo($sakit_p['rawatan_terkini']); ?>', <?php echo(round($i - 1)); ?>, 'id_sakit[]', '<?php echo($sakit_p['id_sakit']); ?>');</script>
                            ...
                            <div id="borang_rekod">
                                <?php if($jum_anak > 0) { $i = 1; do {
                                    ...
                                    <div class="row form-group" id="baris<?php echo($i); ?>">
                                        ...
                                        <div class="col-md-12 form-group"><label>Nama Tanggungan</label><input class="form-control" type="text" name="nama_tanggungan[]" placeholder="Nama Penuh" required value="<?php echo($kemas2['nama_penuh']); ?>"></div>
                                        <div class="col-md-4"><label>No Kad Pengenalan</label><input class="form-control" type="text" name="ic_tanggungan[]" placeholder="Contoh: 001223011234" minlength="12" maxlength="12" value="<?php echo($kemas2['no_ic']); ?>"></div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4"><label>Hubungan</label><input class="form-control" type="text" name="hubungan_tanggungan[]" required value="<?php echo($kemas2['hubungan']); ?>"></div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <label>Mualaf</label>
                                            <select class="form-control form-group" type="text" name="tanggung_mualaf[]" requiredX>
                                                <option value="">Sila Pilih</option>
                                                <option value="Y" <?php if($kemas2['status_mualaf'] == '1') echo('selected'); ?>>Ya</option>
                                                <option value="N" <?php if($kemas2['status_mualaf'] == '2') echo('selected'); ?>>Tidak</option>
                                            </select>
                                        </div>
                                        <div class="col-12 col-md-12">
                                            <script>data_sakit(0, '<?php echo($sakit_kronik); ?>', 'id_penyakit_tanggung_<?php echo($i); ?>[]', 'rawatan_terkini_tanggung_<?php echo($i); ?>[]', 'add_sakit_tanggung_<?php echo($i); ?>', 'borang_sakit_tanggung_<?php echo($i); ?>', 'padam_sakit_tanggung_<?php echo($i); ?>', 'baris_sakit_tanggung_<?php echo($i); ?>', 'id_sakit_tanggung_<?php echo($i); ?>_', 'id_sakit_tanggung_<?php echo($i); ?>[]', 'id_sakit_padam_tanggung_<?php echo($i); ?>[]', '', 'Padam Penyakit')</script>
                                            ...
                                            <div id="borang_sakit_tanggung_<?php echo($i); ?>" class="col-12 col-md-12 form-group">
                                                <?php if($jum_sakit2 > 0) { $u = 1; do { ?>
                                                    <script>data_sakit_ada('#add_sakit_tanggung_<?php echo($i); ?>', 'id_penyakit_tanggung_<?php echo($i); ?>[]', '<?php echo($sakit2['id_penyakit']); ?>', 'rawatan_terkini_tanggung_<?php echo($i); ?>[]', '<?php echo($sakit2['rawatan_terkini']); ?>', <?php echo(round($u - 1)); ?>, 'id_sakit_tanggung_<?php echo($i); ?>[]', '<?php echo($sakit2['id_sakit']); ?>');</script>
