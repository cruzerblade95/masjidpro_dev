		...
		<div class="page-header float-right">
			<div class="page-title">
				<ol class="breadcrumb text-right">
					...
					<li><a href="utama.php?view=admin&action=kemas">Kemas</a></li>
					<li class="active">Semak Kemas</li>
				</ol>
			</div>
		</div>
	</div>
...
<div class="content mt-3">
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">Maklumat KEMAS</div> 
				<div class="card-body">
					<form method="post" action="admin/update_kemas.php" name="kemas">
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<input class="form-control" name="nama_kemas" id="nama_kemas" value="<?php echo $row['nama_kemas'];?>" required />
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
