<?php 
	...
	$idd = $_GET['id'];
	$sql_search="SELECT 
	id,id_masjid, nama_pengurus, no_tel,nama_sekolah,bil_pelajar, alamat, negeri, 
	daerah,poskod
	FROM sej6x_data_sekolah
	WHERE id='".$idd."' ";
		...
		<div class="page-header float-right">
			<div class="page-title">
				<ol class="breadcrumb text-right">
					<li><a href="utama.php?view=admin&action=komuniti">Komuniti</a></li>
					<li><a href="utama.php?view=admin&action=sekolah">Sekolah</a></li>
					<li class="active">Semak Sekolah</li>
				</ol>
			</div>
		</div>
	</div>
...
<div class="content mt-3">
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">Maklumat Sekolah</div> 
				<div class="card-body">
					<form method="post" action="admin/update_sekolah.php" name="sekolah">
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<input class="form-control" name="nama_sekolah" id="nama_sekolah" value="<?php echo $row['nama_sekolah'];?>" required />
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
