<?php
header("Location: https://masjidpro.com");
exit;
?>
<!DOCTYPE html>
<html lang="en">
...
<!--<body background="picture/bg.jpg">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading" align="center">
                        ...
                        PENDAFTARAN AHLI KARIAH</b></h3><br>
  ...
  <body> 
                    <form name="redirect" action="https://www.spmd.tk/Masjid/daftar/pendaftaran.php" method="POST">
                            ...
                            <fieldset>
                                 <div class="form-group">
                                            ...
                                            <select class="form-control" name="selection">
											   ...
											   {
											   ?>
											   <option value="<?php echo $data['url_masjid'];?>"><?php echo $data['nama_masjid'];?></option>
											   <?php
											   }
                                               ?>
                                            </select>
                                ...
                                <div class="form-group">
                                    <input class="btn btn-lg btn-default btn-block" type="submit" name="submit" value="Daftar">
                                </div>
