...
//$db = mysqli_connect('deebugproduction.com', 'booking', 'booking2018', 'booking');
?>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-4">
                                    <form method="post" action="utama.php?view=borang_sewa">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="sewa_tarikh_mula" type="date" disabled>   
                                        </div> 
                                        <div class="form-group">
                                            <label>Tarikh Terima Barang</label>
                                            <input class="form-control" name="sewa_tarikh_akhir" type="date" disabled>   
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                            <label>Perkara</label>
                                            <select  class="form-control" name="sewa_perkara" disabled>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input class="form-control" name="sewa_nama_perkara" disabled>
                                    </div>  
                                </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        >Simpan</button>
                                        <button type="reset" class="btn btn-primary" data-toggle="modal" data-target="#printResit">Cetak Resit</button>
