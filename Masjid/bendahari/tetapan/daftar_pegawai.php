<div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">DAFTAR PEGAWAI MASJID</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
						  ...
						  ?>  
                               ...
                               <form method="post" id="ajkmasjid" action="">          
                                <table class="table table-striped table-bordered table-hover">
	    						    ...
	    						    <div align="center"><a href="utama.php?view=butiran_jawatanpegawai&id_data=<?php echo $row['id_data'];?>"><input type="button" value="Daftar" class="btn btn-success" /></a></div>  
                                            </td>
