                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <button class="btn btn-info" type="button" data-toggle="modal" data-target="#myModal">Tambah Rumah Ibadat </button>                   </div>
                        <!-- /.panel-heading -->
						  ...
						  ?>              
                              ...
                              <?php while($row = mysql_fetch_assoc($result)){ ?>
                                    ...
                                    <td class="center"><div align="center"><?php echo $row['bil_anggota']; ?></div></td>
                                     <td>
                                     <div align="center">
                                      <a href="utama.php?view=semak_rumahibadat&id=<?php echo $row['id'];?>"><button type="btn btn-info" class="btn btn-warning btn-circle" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></button></a>
                                      
                       <form name="delete" method="POST" action="info/del_rumahibadat.php">
