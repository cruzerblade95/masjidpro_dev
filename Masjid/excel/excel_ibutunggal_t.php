...
$objPHPExcel->getActiveSheet()->setCellValue('B2', 'Senarai Tanggungan Ibu Tunggal');
//setting Font Style
$styleFont = array(
	'font' => array(
		'bold'      => true,
...
//$currentYear= get_setting();
	...
	$sql="SELECT * FROM sej6x_data_anakqariah WHERE id_masjid='$id_masjid' AND status_ibutunggal='1'";
...
while($list = mysql_fetch_assoc($sqlquery)){
		...
		$objPHPExcel->getActiveSheet()->setCellValue("E$noindex", $list['no_tel']);
...
$objWriter->save('output/'.$kod_masjid.'/SenaraiIbuTunggalTanggungan.xlsx');
