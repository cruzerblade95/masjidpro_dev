...
$objPHPExcel->getActiveSheet()->setCellValue('D5', 'No Kad Pengenalan');
...
$sql_excel = "SELECT * FROM bantuan_zakat WHERE id_masjid='$id_masjid' AND status_bantuan=1 AND no_ic IS NOT NULL AND (id_data IS NULL AND kariah_masjid!='$id_masjid') ORDER BY id_bantuan ASC";
...
$objWriter->save('output/'.$kod_masjid.'/RekodBantuanBukanAhliKariah.xlsx');
