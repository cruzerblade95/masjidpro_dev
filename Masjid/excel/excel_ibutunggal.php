...
$objPHPExcel->getActiveSheet()->setCellValue('B2', 'Senarai Ahli Kariah Ibu Tunggal');
//setting Font Style
$styleFont = array(
	'font' => array(
		'bold'      => true,
...
//$currentYear= get_setting();
	...
	$sql="SELECT * FROM sej6x_data_peribadi WHERE id_masjid='$id_masjid' AND data_ibutunggal='1'";
...
$objWriter->save('output/'.$kod_masjid.'/SenaraiIbuTunggal.xlsx');
