...
$objPHPExcel->getActiveSheet()->setCellValue('B2', 'Senarai Ahli Kariah Warga Emas');
//setting Font Style
$styleFont = array(
	'font' => array(
		'bold'      => true,
...
//$currentYear= get_setting();
	...
	$sql="SELECT * FROM sej6x_data_peribadi WHERE warga_emas='1' AND id_masjid='$id_masjid'";
