...
$objPHPExcel->getActiveSheet()->setCellValue('B2', 'Senarai Ahli Kariah Orang Kelainan Upaya (OKU)');
//setting Font Style
$styleFont = array(
	'font' => array(
		'bold'      => true,
...
//$currentYear= get_setting();
	...
	$sql="SELECT a.id_data,a.nama_penuh,a.no_ic,a.umur,b.jenis_oku,b.keterangan,b.id_oku FROM sej6x_data_peribadi a, sej6x_data_oku b WHERE a.id_data=b.id_data AND b.id_masjid='$id_masjid'";
...
$objWriter->save('output/'.$kod_masjid.'/SenaraiOKU.xlsx');
