...
$objPHPExcel->getActiveSheet()->setCellValue('B2', 'Senarai Tanggungan Lelaki Layak Mengundi');
//setting Font Style
$styleFont = array(
	'font' => array(
		'bold'      => true,
...
//$currentYear= get_setting();
	...
	$sqll="SELECT * FROM sej6x_data_anakqariah WHERE id_masjid='$id_masjid' AND jantina='1' AND status_undi='1'";
...
while($listl = mysql_fetch_assoc($sqlqueryl)){
		...
		$objPHPExcel->getActiveSheet()->setCellValue("F$noindex", 'Lelaki');
...
$objWriter->save('output/'.$kod_masjid.'/SenaraiLayakMengundiLelakiTanggungan.xlsx');
