...
$objPHPExcel->getActiveSheet()->setCellValue('B2', 'Senarai Ahli Kariah Tanggungan');
//setting Font Style
$styleFont = array(
	'font' => array(
		'bold'      => true,
...
//alignment header
$objPHPExcel->getActiveSheet()->getStyle("B5:E5")->applyFromArray(
		array(
			'font'    => array(
				'bold'      => true,
				'name'		=> 'arial',
...
$objPHPExcel->getActiveSheet()->getStyle('B5:E5')->getAlignment()->setWrapText(true);
...
//$currentYear= get_setting();
	...
	$sql="SELECT * FROM sej6x_data_anakqariah WHERE status_wargaemas='1' AND id_masjid='$id_masjid'";
...
//alignment list
$tindex = $cnt + 5;
$objPHPExcel->getActiveSheet()->getStyle("B6:E$tindex")->applyFromArray(
		array(
			'font'    => array(
				'name'		=> 'arial',
				'size'		=> '8'
...
$objPHPExcel->getActiveSheet()->getStyle("B6:E$tindex")->getAlignment()->setWrapText(true);
...
$objWriter->save('output/'.$kod_masjid.'/SenaraiWargaEmasTanggungan.xlsx');
