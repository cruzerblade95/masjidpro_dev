...
$objPHPExcel->getActiveSheet()->setCellValue('B2', 'Senarai Wargaemas');
//setting Font Style
$styleFont = array(
      'font' => array(
            'bold'      => true,
...
$objPHPExcel->getActiveSheet()->setCellValue('D5', 'No. KP');
...
$sqll="SELECT * FROM sej6x_data_peribadi WHERE id_masjid='$id_masjid' AND warga_emas='1'";
...
while($listl = mysql_fetch_assoc($sqlqueryl)){
   ...
   $objPHPExcel->getActiveSheet()->setCellValue("F$noindex", $listl['umur']);
...
$objWriter->save('output/'.$kod_masjid.'/Senaraiwargaemas.xlsx');
