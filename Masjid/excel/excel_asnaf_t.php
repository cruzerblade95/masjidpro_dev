...
$objPHPExcel->getActiveSheet()->setCellValue('B2', 'Senarai Tanggungan Asnaf');
//setting Font Style
$styleFont = array(
	'font' => array(
		'bold'      => true,
...
//$currentYear= get_setting();
	...
	$sql="SELECT * FROM sej6x_data_anakqariah WHERE id_masjid='$id_masjid' AND status_asnaf='1'";
...
$objWriter->save('output/'.$kod_masjid.'/SenaraiAsnafTanggungan.xlsx');
