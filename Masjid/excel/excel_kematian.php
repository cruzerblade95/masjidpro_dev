...
$objPHPExcel->getActiveSheet()->setCellValue('B2', 'Senarai Kematian Ahli Kariah ');
//setting Font Style
$styleFont = array(
	'font' => array(
		'bold'      => true,
...
//$currentYear= get_setting();
	...
	$sql="SELECT b.nama_penuh,b.no_ic,a.tarikh_kematian,a.tarikh_dikebumikan,a.id_data,a.id_kematian,b.id_data,b.data_kematian
									FROM data_kematian a,sej6x_data_peribadi b
									WHERE a.id_data=b.id_data AND b.data_kematian='1' AND b.id_masjid='$id_masjid'"; ;
...
$objWriter->save('output/'.$kod_masjid.'/SenaraiKematian.xlsx');
