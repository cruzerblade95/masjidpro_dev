...
$objPHPExcel->getActiveSheet()->setCellValue('B2', 'Senarai Ahli Kariah Sakit Kronik');
//setting Font Style
$styleFont = array(
	'font' => array(
		'bold'      => true,
...
//$currentYear= get_setting();
	...
	$sql="SELECT a.nama_penuh, a.no_ic, b.jenis_penyakit, b.rawatan_terkini FROM sej6x_data_peribadi a, sej6x_data_sakit b WHERE a.id_data=b.id_data AND a.id_masjid='$id_masjid' AND a.data_sakit='1'";
...
$objWriter->save('output/'.$kod_masjid.'/SenaraiSakitKronik.xlsx');
