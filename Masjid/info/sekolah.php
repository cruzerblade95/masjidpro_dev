                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Senarai SEKOLAH
                            <button class="btn btn-info" type="button" data-toggle="modal" data-target="#myModal">Tambah Sekolah </button>                   </div>
                        <!-- /.panel-heading -->
						  ...
						  ?>              
                              ...
                              <?php while($row = mysql_fetch_assoc($result)){ ?>
                                    ...
                                    <td class="center">
                                      ...
                                      <a href="utama.php?view=semak_sekolah&id=<?php echo $row['id'];?>"><button type="btn btn-info" class="btn btn-warning btn-circle" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></button>
                                      
                       <form name="delete" method="POST" action="info/del_sekolah.php">
