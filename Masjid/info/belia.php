    ...
    <div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">BELIA</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Senarai Belia
                            <button class="btn btn-info" type="button" data-toggle="modal" data-target="#myModal">Tambah Belia </button>                   </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
						  ...
						  $sql_search="SELECT id,nama_pengurus,no_tel,bil_anggota,nama_belia FROM sej6x_data_beliaa"; 
						  ...
						  ?>              
                              ...
                              <?php while($row = mysql_fetch_assoc($result)){ ?>
                                    ...
                                    <td>
                                      <div align="center">
                                      <a href="utama.php?view=semak_belia&id=<?php echo $row['id'];?>"><button type="btn btn-info" class="btn btn-warning btn-circle" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></button>
                                      
                       <form name="delete" method="POST" action="info/del_belia.php">
...
$(document).ready(function(){
	...
	if($('#no_tel').val() == "")  
	  ...
	  if($('#nama_belia').val() == "")  
	  {  
		alert("Nama Belia tidak dimasukan");  
	  }  
	  if($('#alamat').val() == "")  
	  {  
