...
if(!empty($_POST))
{
	...
	$sql1 ="INSERT INTO sej6x_data_persatuan(id,id_masjid, nama_pengurus, no_tel,nama_persatuan,bil_anggota, alamat, negeri, 
	        daerah,poskod,last_added)
			   		VALUES('',$id_masjid,'$nama_pengurus','$no_tel','$nama_persatuan',$bil_anggota,'$alamat','$negeri',
			'$daerah',$poskod,NOW())";

$test=mysql_query($sql1, $bd);
	if($test)
	{
		    header("location: ../utama.php?view=persatuan"); 
	}
	else
	{
		echo mysql_error();
