            ...
            <form id="detail_tempahan" name="detail_tempahan" method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?>">
                <div class="md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="id_bilik" name="id_bilik" class="form-control" value="<?php echo $row['id_bilik'];?>" readonly/>
                    </div>
                    <div class="form-group">
                        <label for="check_in">Tarikh Daftar Masuk <span class="help"></span></label>
                        <input type="date" id="check_in" name="check_in" class="form-control" value="<?php echo $row['check_in'];?>" readonly/>
                    </div>
                    <div class="form-group">
                        <label for="check_out">Tarikh Daftar Keluar<span class="help"></span></label>
                        <input type="date" id="check_out" name="check_out" class="form-control" value="<?php echo $row['check_out'] ;?>" readonly/>
                    </div>
            </form>
        </div>
    </div>
