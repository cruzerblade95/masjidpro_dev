...
$query = "SELECT id_produk, image, id_subcategory, nama_produk, harga FROM products_ecomasjid WHERE id_masjid= '$id_masjid' AND id_subcategory = 1 OR id_subcategory= 2";
