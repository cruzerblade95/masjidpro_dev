        ...
        <div class="card card-body">
            <form id="edit_produk" name="edit_produk" method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" class="btn btn-dark" onclick="location.href='utama.php?view=admin&action=gomasjidpro&page=ecomasjid_list_produk'">Batal</button>
                    </div>
            </form>
        </div>
    </div>
