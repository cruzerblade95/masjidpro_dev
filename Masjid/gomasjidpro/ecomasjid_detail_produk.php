        ...
        <div class="card card-body">
            <form id="detail_produk" name="detail_produk" method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?>">
                <div class="md-4">
                    ...
                    <div class="md-4 mb-4">
                        <label for="id_subcategory">Sub-kategori Produk</label>
                    ...
                    <div class="md-4 mb-4 ">
                        <div class="form-group">
                            ...
                            <input type="text" id="id_negeri" name="id_negeri" class="form-control" value="<?php echo $row['id_negeri'];?>" readonly/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="id_daerah">ID Daerah <span class="help"></span></label>
                        <input type="text" id="id_daerah" name="id_daerah" class="form-control" value="<?php echo $row['id_daerah'];?>" readonly/>
                    </div>
                    <div class="form-group">
                        <label for="id_masjid">ID Masjid <span class="help"></span></label>
                        <input type="text" id="id_masjid" name="id_masjid" class="form-control" value="<?php echo $row['id_masjid'];?>" readonly/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="kuantiti" name="kuantiti" type="number" class="form-control" value="<?php echo $row['kuantiti'];?>" readonly/>
                    </div>
                    <div class="form-group">
