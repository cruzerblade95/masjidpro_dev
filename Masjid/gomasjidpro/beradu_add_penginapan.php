...
if($_SERVER['REQUEST_METHOD'] == "POST" ) {
    ...
    $sql = "INSERT INTO products_ecomasjid(id_category, id_subcategory, id_negeri, id_daerah, id_masjid, nama_produk, harga, description, address,$dataCol kuantiti,rating) 
                    VALUES ('$id_category','$id_subcategory','$id_negeri','$id_daerah','$id_masjid','$nama_produk','$harga','$description','$address',$data_val'$kuantiti','$rating') ";
    ...
    <div class="col-sm-12">
        <div class="card card-body">
            <form id="add_produk" name="add_produk" method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?>">
                <div class="md-4">
                    <h5 class="m-t-30">Kategori Penginapan</h5>
                    <?php
                    $sql="SELECT id_category, category FROM category_ecomasjid WHERE id_category=2";
                ...
                <div class="md-4 mb-4">
                    <h5 class="m-t-30">Sub-kategori Penginapan</h5>
                    <?php
                    //$id = $_GET['cat'];
                    $sql2="SELECT * FROM ecomasjid_subcategory WHERE id_category=2";
