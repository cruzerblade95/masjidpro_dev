<div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">DAFTAR KEMATIAN KARIAH</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
                                    ...
                                    <?php while($row = mysql_fetch_assoc($result)){ ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><div align="center"><?php echo $row['no_ic']; ?></div></td>
                                             <td>
              <div align="center"><a href="utama.php?view=butiran_kematian&id_data=<?php echo $row['id_data'];?>"><input type="button" value="Daftar" class="btn btn-success" /></a></div> 
                                            </td>
