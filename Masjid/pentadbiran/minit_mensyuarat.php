    ...
    <div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="page-header">MINIT MENSYUARAT</h1>
                </div>
                <!-- /.col-lg-12 -->
</div>
            <!-- /.row -->
 <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="row"> 
                  <form action="pentadbiran/add_minitmensyuarat.php" method='post' enctype="multipart/form-data">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
							   ...
							   $result= mysql_query( "SELECT id,tarikh,description,filename FROM 
							    minit_mensyuarat
                               ...
                               ?>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                  ...
                                  $files_show= "Mensyuarat/files/$files_field";
                                  $descriptionvalue= $row['description'];  ?>
                                        <tr class="odd gradeX">
                                           ...
                                           <td><div align="center">
                                           <form name="delete" method="POST" action="pentadbiran/del_minitmensyuarat.php">
