...
<section id="wrapper">
    ...
    <div class="col-lg-12 col-xlg-12 col-md-12">
        <div class="card" id="card" style="background-image: url('images/logo_masjidpropenang_opacity.png');
            ...
            <div class="card-body">
                <center class="m-t-30">
                    <button onClick="window.print()" id="printbtn" class="btn btn-info"><i class="fas fa-print"></i>&nbsp;Cetak</button>
                    <br>
    ...
    <footer>
        Dicetak Oleh : <?php echo $_SESSION['user_name'] ?><br>
        Tarikh Cetak : <?php echo fungsi_tarikh(date('Y-m-d H:i:s'),1,1); ?>
        <br>
