...
if (isset($_POST['simpan'])) {
    ...
    if ($run > 0) {
        ...
        if ($row > 0) {
            echo "<script>
				alert('Maklumat tuan/puan sedang diproses untuk pengesahan.');
				</script>";
        } else if ($row == 0) {
...
<!-- Font Awesome -->
<script src="https://kit.fontawesome.com/b5589dbb40.js"
...
<body style="background-color: #4e4e52">
	...
	<div class="col-lg-8">
		<div class="card">
			<div class="card-body">
				<form method="post" id="insert_form" action="daftarqariah.php">
			<?php
include ("../../connection_app.php");
...
?>          
						...
						<div class="col-lg-4">
							<div class="form-group">
								<label style="color: red">*</label><b>Nama Penuh</b> <input
									class="form-control" name="nama_penuh" id="nama_penuh" required>
							</div>
							<div class="form-group">
								<label style="color: red">*</label><b>No. K/P</b> <input
									...
									maxlength="12" required onChange="myFunction()">
							</div>
							<div class="form-group">
								<label style="color: red">*</label><b>No Telefon</b> <input
									class="form-control" name="no_hp" id="no_hp"
									placeholder="Contoh: 0143159891" required>
							</div>
							<div class="form-group">
								<label style="color: red">*</label><b>Umur</b> <input
									class="form-control" name="umur" id="umur" readonly required>
							</div>
							<div class="form-group">
								<label style="color: red">*</label><b>Tarikh Lahir</b> <input
									class="form-control" name="tarikh_lahir" id="tarikh_lahir"
									placeholder="Contoh: 1992-05-30" type="date" readonly required>
							</div>
							<div class="form-group">
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input class="form-control"
									...
									name="alamat_terkini" id="alamat_terkini" required>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label style="color: red">*</label><b>Negeri</b> <select
									...
									onChange="showDaerah(this.value)" required>
    ...
    ?>
							...
							<br> Sila isi semua maklumat yang bertanda<label
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="form-group">
								<label style="color: red">*</label><b>Warga Emas</b> <select
									class="form-control" name="warga_emas" id="warga_emas" readonly
									required>
									<option value="0">Sila Pilih</option>
						...
						<div class="col-lg-4">
							<div class="form-group">
								<label style="color: red">*</label><b>Wajib Solat Jumaat</b> <select
									class="form-control" name="solat_jumaat" id="solat_jumaat"
									required>
									<option value="0">Sila Pilih</option>
						...
						<div class="col-lg-4">
							<div class="form-group">
								<label style="color: red">*</label><b>OKU</b> <select
									class="form-control" name="oku" id="oku" required>
									<option value="0">Sila Pilih</option>
									<option value="1">Ya</option>
					...
					<div class="row">
						<div class="col-lg-12" style="overflow-x: auto;">
							<div class="form-group">
								...
								<td><input class="form-control" type="text" name="tanggung_oku[]" requiredX></td>
								<td><input class="form-control" type="text" name="tanggung_kahwin[]" requiredX></td>
								<td><input class="form-control" type="text" name="tanggung_sakitkronik[]" requiredX></td>
								<td><input class="form-control" type="text" name="tanggung_asnaf[]" requiredX></td>
								<td><button type="button" name="add" id="add" onClick="insertRow()" class="btn btn-success">+</button></td>
							</tr> -->
								</table>
								<center>
									<button type="button" name="add" id="add" onClick="insertRow()"
						...
						<div class="col-lg-12">
							<center>
								<input type="hidden" name="selection"
									value="<?php echo $url_masjid; ?>"> <input type="submit"
...
function showDaerah(str) {
	...
	$.getJSON("../../common/getdaerah.php?kodnegeri="+str, function (data) {
...
function showMasjid(str) {
	...
	$.getJSON("../../common/getmasjid.php?kodnegeri="+$('#id_negeri option:selected').val()+"&koddaerah="+str, function (data) {
		$.each(data.result, function (indexs, values) {
...
function showZon(str) {
	...
	$.getJSON("../../common/getzon.php?kodmasjid="+$('#id_masjid option:selected').val(), function (data) {
		$.each(data.result, function (indexs, values) {
...
<script
	src="../../../assets/js/init-scripts/data-table/datatables-init.js"></script>
