...
if($tahun != NULL && $tahun != -1) {
    if($tahun != NULL && $_GET['bulan1'] != NULL) {
        ...
        $tarikh_akhir = fungsi_tarikh("$tahun-$bulanNum2-$hujungBulan2 12:00:00", 7, 99);
        $setTarikh = "AND (a.dateRecords BETWEEN '$tahun-$bulanNum-01' AND '$tahun-$bulanNum2-$hujungBulan2')";
        $setTarikhs = "AND (a.dateRecords BETWEEN '$tahun-01-01' AND '$tahun-12-31')";
...
WHERE a.id_masjid = $id_masjid AND b.assetType IN (1, 2, 3, 4, 5, 6, 7) AND a.voidStatus != 1 AND a.typeModule = $training $setTarikhs";
...
<?php if($_GET['tahun'] != NULL || $_GET['bulan'] != NULL) { if($_GET['tabungan'] == 2) { ?>
    <table data-hidden="1" width="100%" border="1" cellpadding="5" cellspacing="0" id="bah_a">
        <tr>
        ...
        <tr id="rowSurplus" style="border: none; display: none;">
            <td align="center" class="isi-padat">****</td>
            <td align="left" class="isi-padat">Pendapatan melebihi perbelanjaan sebanyak</td>
            <td align="right" class="isi-padat"></td>
            <td align="right" class="isi-padat" bgcolor="#7bde76"><label id="percentage_pendapatan"></label>%</td>
            <td align="right" class="isi-padat"></label></td>
            <td align="right" class="isi-padat"><label id="jum_baki_1"></label></td>
            <!-- <td align="right" class="isi-padat"></td> -->
        </tr>
        <tr id="rowDeficit" style="border: none; display: none;">
            <td align="center" class="isi-padat">****</td>
            <td align="left" class="isi-padat">Perbelanjaan melebihi perbelanjaan sebanyak</td>
            <td align="right" class="isi-padat"></td>
            <td align="right" class="isi-padat"></td>
            <td align="right" class="isi-padat" bgcolor="#d67272"><label id="percentage_perbelanjaan"></label>%</td>
            <td align="right" class="isi-padat"><label id="jum_baki_2"></label></td>
            <!-- <td align="right" class="isi-padat"></td> -->
        </tr>
    </table>
    <br /><br />
<?php } ?>
    <?php if($_GET['tabungan'] == 2) { ?><h4 align="center">PERINCIAN PENDAPATAN DAN PERBELANJAAN TABUNGAN</h4><br /><?php } ?>
    <table data-hidden="2" width="100%" border="1" cellpadding="5" cellspacing="0" id="bah_a">
        <tr>
        ...
        <?php $i = 1; $jum_baki = 0; do {
           ...
           ($sub_select1 (
            ...
            WHERE a.accountsCategory_id = $id_akaun AND a.id_masjid = $id_masjid AND a.typeModule = $training $setTarikhs
    ...
    <?php if($_GET['tabungan'] == 2) { ?>
        <br /><br />
        <h4 align="center">PERINCIAN PENDAPATAN DAN PERBELANJAAN ASET</h4><br />
